...
export const insertEmployees = async (username, password, orgcode, branchname, orgname, fullname, branchcode) => {
    try {
        ...
        await connection.execute(`
            INSERT INTO employees (username, password, branchname, orgcode, orgname, fullname, branchcode) 
            VALUES (?, ?, ?, ?, ?, ?, ?)
        `, [username, password, branchname, orgcode, orgname, fullname, branchcode]);
