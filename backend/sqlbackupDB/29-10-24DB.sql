...
CREATE TABLE `approvalexpjob` (
  ...
  `remark` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store approvexpjob before actually approving or rejecting';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `approvalimpjob` (
  ...
  `remark` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store approvaljob before actually approving or rejecting';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `impgeneral` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_job_number` (`jobnumber`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is to store the general component data ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `impnotifications` (
  ...
  `username` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store import notifications ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `milestone` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table contains all the milestones';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reminders` (
  ...
  `jobnumber` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store reminders for import';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reminders` VALUES ('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','E-SANCHIT',7,'2024-10-07T06:52:00.000Z','Air EXPORT','Mumbai','1','00','00','Pending',14,'A/Mumbai/E/24-25/4'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','PORT CFS NOMINATION',9,'2024-10-20T11:35:00.000Z','Air IMPORT','Mumbai','1','00','00','Pending',10,'A/Mumbai/I/24-25/19'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','processing',10,'2024-10-14T11:35:00.000Z','Air IMPORT','Mumbai','2','00','00','Pending',11,'A/Mumbai/I/24-25/19'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','Scanning ',11,'2024-10-06T11:21:00.000Z','Air IMPORT','Mumbai','1','00','00','Pending',15,'A/Mumbai/I/24-25/19'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','Packaging',12,'2024-10-03T11:21:00.000Z','Air IMPORT','Mumbai','3','00','00','Pending',16,'A/Mumbai/I/24-25/19'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','ETA',13,'2024-10-20T13:05','Air EXPORT','Mumbai','2','00','00','Pending',13,'A/Mumbai/E/24-25/4'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','ETA',14,'2024-10-20T11:15','Air IMPORT','Jogbani','1','00','00','Pending',19,'Jogbani/A/24-25/10/I'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','ETA',15,'2024-10-04T17:10','Air IMPORT','Mumbai','2','00','00','Pending',8,'A/Mumbai/I/24-25/18'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','E-SANCHIT',16,'2024-10-02T11:40:00.000Z','Air IMPORT','Mumbai','1','00','00','Pending',9,'A/Mumbai/I/24-25/18'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','PORT CFS NOMINATION',17,'2024-10-06T11:40:00.000Z','Air IMPORT','Mumbai','1','00','00','Pending',10,'A/Mumbai/I/24-25/18'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','processing',18,'2024-09-30T11:40:00.000Z','Air IMPORT','Mumbai','2','00','00','Pending',11,'A/Mumbai/I/24-25/18'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','ETA',19,'2024-10-27T14:38','Air IMPORT','Jogbani','1','00','00','Pending',19,'Jogbani/A/24-25/13/I'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','PORT  CFS',20,'2024-10-26T09:08:00.000Z','Air IMPORT','Jogbani','2','00','00','Pending',24,'Jogbani/A/24-25/13/I'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','ETA',21,'2024-11-08T14:39','Air IMPORT','Jogbani','1','00','00','Pending',22,'Jogbani/A/24-25/12/I'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','E-SANCHIT',22,'2024-11-07T09:09:00.000Z','Air IMPORT','Jogbani','1','00','00','Pending',23,'Jogbani/A/24-25/12/I'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','ETA',23,'2024-10-27T16:10','Air IMPORT','Mumbai','1','00','00','Pending',20,'A/Mumbai/I/24-25/21'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','E-SANCHIT',24,'2024-10-26T10:40:00.000Z','Air IMPORT','Mumbai','3','00','00','Pending',21,'A/Mumbai/I/24-25/21'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"rishi@manager\"}, {\"username\": \"aayush@manager\"}]','E-SANCHIT',25,'2024-10-19T07:23:00.000Z','Air IMPORT','Mumbai','2','00','00','Pending',2,'A/Mumbai/I/24-25/2'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"rishi@manager\"}, {\"username\": \"aayush@manager\"}]','PORT CFS NOMINATION',26,'2024-10-17T07:23:00.000Z','Air IMPORT','Mumbai','2','00','00','Pending',3,'A/Mumbai/I/24-25/2'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"rishi@manager\"}, {\"username\": \"aayush@manager\"}]','processing',27,'2024-10-19T07:23:00.000Z','Air IMPORT','Mumbai','2','6','25','Pending',4,'A/Mumbai/I/24-25/2');
...
INSERT INTO `setworkflow` VALUES (1,'Air IMPORT','Mumbai','ALL','Seawave Forwarding Logistics','seawave@2323','','','','','',1,'ETA','[{\"username\": \"hemang@executive\"}, {\"username\": \"rishi@manager\"}, {\"username\": \"aayush@manager\"}]','1','00','00','2024-10-29 06:19:29','','','',''),(2,'Air IMPORT','Mumbai','ALL','Seawave Forwarding Logistics','seawave@2323','ETA','After','2','00','00',0,'E-SANCHIT','[{\"username\": \"hemang@executive\"}, {\"username\": \"rishi@manager\"}, {\"username\": \"aayush@manager\"}]','2','00','00','2024-10-29 06:20:18','','','',''),(3,'Air IMPORT','Mumbai','ALL','Seawave Forwarding Logistics','seawave@2323','E-SANCHIT','Before','2','00','00',0,'PORT CFS NOMINATION','[{\"username\": \"hemang@executive\"}, {\"username\": \"rishi@manager\"}, {\"username\": \"aayush@manager\"}]','2','00','00','2024-10-29 06:23:17','','','',''),(4,'Air IMPORT','Mumbai','ALL','Seawave Forwarding Logistics','seawave@2323','PORT CFS NOMINATION','After','2','00','00',0,'processing','[{\"username\": \"hemang@executive\"}, {\"username\": \"rishi@manager\"}, {\"username\": \"aayush@manager\"}]','2','6','25','2024-10-29 06:25:23','','','',''),(6,'Air IMPORT','Mumbai','Allcargo Pvt Ltd','Seawave Forwarding Logistics','seawave@2323','','','','','',1,'ETA','[{\"username\": \"hemang@executive\"}, {\"username\": \"rishi@manager\"}, {\"username\": \"aayush@manager\"}]','2','00','00','2024-10-29 06:27:52','Yes','Yes','Break Bulk','Home'),(7,'Air IMPORT','Mumbai','Allcargo Pvt Ltd','Seawave Forwarding Logistics','seawave@2323','ETA','Before','3','00','00',0,'E-SANCHIT','[{\"username\": \"hemang@executive\"}, {\"username\": \"rishi@manager\"}, {\"username\": \"aayush@manager\"}]','2','00','00','2024-10-29 06:28:18','Yes','Yes','Break Bulk','Home'),(8,'Air IMPORT','Mumbai','Allcargo Pvt Ltd','Seawave Forwarding Logistics','seawave@2323','Job Creation Date','After','2','00','00',0,'PORT CFS NOMINATION','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','2','00','00','2024-10-29 06:28:52','Yes','Yes','Break Bulk','Home'),(9,'Air EXPORT','Mumbai','ALL','Seawave Forwarding Logistics','seawave@2323','','','','','',1,'ETA','[{\"username\": \"hemang@executive\"}, {\"username\": \"rishi@manager\"}, {\"username\": \"aayush@manager\"}]','1','00','00','2024-10-29 06:41:47','','','',''),(10,'Air EXPORT','Mumbai','ALL','Seawave Forwarding Logistics','seawave@2323','ETA','Before','3','00','00',0,'E-SANCHIT','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}, {\"username\": \"rishi@manager\"}]','1','00','00','2024-10-29 06:43:12','','','',''),(11,'Air EXPORT','Mumbai','C CONNECT LOGGI','Seawave Forwarding Logistics','seawave@2323','','','','','',1,'ETA','[{\"username\": \"hemang@executive\"}, {\"username\": \"rishi@manager\"}, {\"username\": \"aayush@manager\"}]','2','9','30','2024-10-29 09:21:48','Yes','Yes','Break Bulk','Home');
...
INSERT INTO `trackingimport` VALUES (1,'ETA','2024-10-17T07:23:00.000Z','2024-10-29T12:54','288 hr 1 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/2','admin','d hr min','Air IMPORT','Mumbai','Mumbai-2323','C CONNECT LOGGI'),(2,'PORT CFS NOMINATION','2024-10-29T12:53',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/2','admin','2 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','C CONNECT LOGGI'),(3,'processing','2024-10-29T12:53',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/2','admin','2 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','C CONNECT LOGGI'),(4,'E-SANCHIT','2024-10-19T12:53',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/2','admin','2 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','C CONNECT LOGGI');
...
CREATE TABLE `workflow` (
  ...
  `orgcode` varchar(50) NOT NULL,
  `importername` varchar(150) DEFAULT 'null',
  `betype` varchar(45) DEFAULT 'null',
  `ownbooking` varchar(45) DEFAULT 'null',
  `owntransport` varchar(45) DEFAULT 'null',
  `consignmenttype` varchar(45) DEFAULT 'null',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store the workflow rows ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `workflow` VALUES (1,'Air IMPORT','Mumbai','Seawave Forwarding Logistics','seawave@2323','ALL','','','',''),(2,'Air IMPORT','Mumbai','Seawave Forwarding Logistics','seawave@2323','Allcargo Pvt Ltd','Home','Yes','Yes','Break Bulk'),(3,'Air EXPORT','Mumbai','Seawave Forwarding Logistics','seawave@2323','ALL','','','',''),(4,'Air EXPORT','Mumbai','Seawave Forwarding Logistics','seawave@2323','C CONNECT LOGGI','Home','Yes','Yes','Break Bulk'),(5,'Air IMPORT','Jogbani','Seawave Forwarding Logistics','seawave@2323','Allcargo Pvt Ltd','SEZ-Z','Yes','Yes','FCL');
...
-- Dump completed on 2024-10-29 15:16:50
