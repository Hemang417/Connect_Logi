...
CREATE TABLE `approvalimpjob` (
  ...
  `remark` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store approvaljob before actually approving or rejecting';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `impgeneral` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_job_number` (`jobnumber`)
) ENGINE=InnoDB AUTO_INCREMENT=165 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is to store the general component data ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `impjobcreation` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_jobnumber` (`jobnumber`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is where all creation of job in import will be stored';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `impnotifications` (
  ...
  `username` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store import notifications ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reminders` (
  ...
  `jobnumber` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store reminders for import';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reminders` VALUES ('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','E-SANCHIT',7,'2024-10-07T06:52:00.000Z','Air EXPORT','Mumbai','1','00','00','Pending',14,'A/Mumbai/E/24-25/4');
...
INSERT INTO `trackingexport` VALUES (1,'ETA','2024-10-26T15:57',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/E/24-25/4','hemang@executive',' d  hr  min','Air IMPORT','Mumbai','Mumbai-2323','C CONNECT LOGGI'),(2,'E-SANCHIT','2024-10-07T12:22',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/E/24-25/4','hemang@executive','2 d 00 hr 00 min','Air IMPORT','Mumbai','Mumbai-2323','C CONNECT LOGGI'),(3,'ETA','2024-10-26T10:56:00.000Z','2024-10-10T16:26','-384 hr 0 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/E/3/24-25','hemang@executive','d hr min','Air EXPORT','Mumbai','Mumbai-2323','C CONNECT LOGGI'),(4,'E-SANCHIT','2024-10-06T11:37:00.000Z','2024-10-10T16:29','95 hr 22 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/E/3/24-25','hemang@executive','2d 00hr 00min','Air EXPORT','Mumbai','Mumbai-2323','C CONNECT LOGGI');
...
INSERT INTO `trackingimport` VALUES (1,'ETA','2024-10-19T13:12',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/16','hemang@executive',' d  hr  min','Air IMPORT','Mumbai','Mumbai-2323','Prince LLP'),(2,'PORT CFS NOMINATION','2024-10-21T13:12',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/16','hemang@executive','2 d 00 hr 00 min','Air IMPORT','Mumbai','Mumbai-2323','Prince LLP'),(3,'processing','2024-10-15T13:12',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/16','hemang@executive','4 d 00 hr 00 min','Air IMPORT','Mumbai','Mumbai-2323','Prince LLP'),(4,'E-SANCHIT','2024-10-17T13:12',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/16','hemang@executive','2 d 00 hr 00 min','Air IMPORT','Mumbai','Mumbai-2323','Prince LLP'),(5,'ETA','2024-10-26T08:45:00.000Z','2024-10-10T14:23','-384 hr -52 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/18','hemang@executive','d hr min','Air IMPORT','Mumbai','Mumbai-2323','Allcargo Pvt Ltd'),(6,'processing','2024-10-22T14:15',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/18','hemang@executive','4 d 00 hr 00 min','Air IMPORT','Mumbai','Mumbai-2323','Allcargo Pvt Ltd'),(7,'E-SANCHIT','2024-10-24T08:45:00.000Z','2024-10-10T14:30','-336 hr -45 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/18','hemang@executive','2d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','Allcargo Pvt Ltd'),(8,'PORT CFS NOMINATION','2024-10-28T14:15',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/18','hemang@executive','2 d 00 hr 00 min','Air IMPORT','Mumbai','Mumbai-2323','Allcargo Pvt Ltd'),(9,'ETA','2024-10-19T14:36','2024-10-10T14:55','-216 hr -41 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/17','hemang@executive','d hr min','Air IMPORT','Mumbai','Mumbai-2323','C CONNECT LOGGI'),(10,'PORT CFS NOMINATION','2024-10-21T14:36',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/17','hemang@executive','2 d 00 hr 00 min','Air IMPORT','Mumbai','Mumbai-2323','C CONNECT LOGGI'),(11,'processing','2024-10-15T14:36',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/17','hemang@executive','4 d 00 hr 00 min','Air IMPORT','Mumbai','Mumbai-2323','C CONNECT LOGGI'),(12,'E-SANCHIT','2024-10-17T09:06:00.000Z','2024-10-10T14:47','-168 hr -49 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/17','hemang@executive','2d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','C CONNECT LOGGI'),(13,'ETA','2024-10-12T15:42','2024-10-10T16:19','-48 hr -23 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/19','hemang@executive','d hr min','Air IMPORT','Mumbai','Mumbai-2323','C CONNECT LOGGI'),(14,'E-SANCHIT','2024-10-10T10:12:00.000Z','2024-10-10T16:19','0 hr 37 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/19','hemang@executive','2d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','C CONNECT LOGGI'),(15,'processing','2024-10-08T15:42',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/19','hemang@executive','4 d 00 hr 00 min','Air IMPORT','Mumbai','Mumbai-2323','C CONNECT LOGGI'),(16,'Scanning ','2024-10-06T16:51',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/19','hemang@executive','3  d 00 hr 00 min','Air IMPORT','Mumbai','Mumbai-2323','C CONNECT LOGGI'),(17,'PORT CFS NOMINATION','2024-10-14T15:42',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/19','hemang@executive','2 d 00 hr 00 min','Air IMPORT','Mumbai','Mumbai-2323','C CONNECT LOGGI'),(18,'Packaging','2024-10-03T16:51',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/19','hemang@executive','3 d 00 hr 00 min','Air IMPORT','Mumbai','Mumbai-2323','C CONNECT LOGGI');
...
-- Dump completed on 2024-10-14 11:23:45
