...
INSERT INTO `accesscontrol` VALUES (41,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','ORGANIZATION','download-client','admin'),(43,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','ORGANIZATION','delete-client','admin'),(49,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Jogbani','Jogbani-2323','EXPORT','add-job','admin'),(50,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Jogbani','Jogbani-2323','EXPORT','delete-job','admin'),(67,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','IMPORT','add-job','admin'),(84,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','ORGANIZATION','add-client','admin'),(90,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','IMPORT','track-job','admin'),(97,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','IMPORT','container-details','admin'),(98,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','IMPORT','transport','admin'),(114,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','IMPORT','delete-job','admin'),(115,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','IMPORT','download-job','admin'),(123,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','ACCOUNTS','add-credit','admin'),(145,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','ACCOUNTS','edit-debit','admin'),(146,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','ACCOUNTS','add-debit','admin'),(184,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','ACCOUNTS','add-bank','admin'),(197,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','ACCOUNTS','delete-bank','admin'),(211,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','ACCOUNTS','download-bank','admin'),(226,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','ACCOUNTS','add-paye','admin'),(227,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','ACCOUNTS','delete-paye','admin'),(244,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','ACCOUNTS','download-paye','admin');
...
CREATE TABLE `approvername` (
  ...
  `createdAt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=98 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store all the names of users for a particular approval list';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-05-27 11:31:19
