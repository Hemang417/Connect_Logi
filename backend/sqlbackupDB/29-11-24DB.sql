...
CREATE TABLE `credit` (
  ...
  `totalForAgainstBill` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_ci DEFAULT NULL,
  `onAcType` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_ci DEFAULT NULL,
  `jobNoForAgainstJob` json DEFAULT NULL,
  `amountForAgainstJob` json DEFAULT NULL,
  `totalForAgainstJob` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_ci DEFAULT NULL,
  `AgainstOutstandingPayment Advise` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2024-11-29 14:50:24
