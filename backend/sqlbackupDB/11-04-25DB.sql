...
CREATE TABLE `adminchangeapproval` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='if password is change before updating it should go for admin approval';
...
INSERT INTO `adminchangeapproval` VALUES (4,'hemang@executive','executive','12345','Approved','bhul gya password','seawave2323','2024-09-20 12:19:35'),(6,'sanjeet@Developer','Developer','1212','Approved','trial','seawave@2323','2025-04-04 10:37:53'),(7,'sanjeet@Developer','Developer','1212','Approved','trial1','seawave@2323','2025-04-04 10:37:53'),(8,'sanjeet@Developer','Developer','12345','Approved','reset password','seawave@2323','2025-04-04 10:37:53');
...
CREATE TABLE `approvalimpjob` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store approvaljob before actually approving or rejecting';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `approverlist` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store the name of the approver list of a particular organization';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `approverlist` VALUES ('Seawave Forwarding Logistics','seawave@2323',3,'Import Job Creation','Mumbai','Mumbai-2323','[\"ImpJobButton\"]',1),('Seawave Forwarding Logistics','seawave@2323',5,'Import Job Creation','Jogbani','Jogbani-2323','[\"ImpJobButton\"]',1),('Seawave Forwarding Logistics','seawave@2323',8,'Export Job Creation','Mumbai','Mumbai-2323','[\"ExpJobButton\"]',1),('Seawave Forwarding Logistics','seawave@2323',9,'Organization Creation','Mumbai','Mumbai-2323','[\"OrgButton\"]',1),('Seawave Forwarding Logistics','seawave@2323',10,'Export Job Creation','Jogbani','Jogbani-2323','[\"ExpJobButton\"]',0),('Seawave Forwarding Logistics','seawave@2323',11,'Organization Creation','Jogbani','Jogbani-2323','[\"OrgButton\"]',0);
...
CREATE TABLE `approvername` (
  ...
  `aid` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store all the names of users for a particular approval list';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `approvername` VALUES (26,'Seawave Forwarding Logistics','seawave@2323','Import Job Creation','hemang@executive','Mumbai','Mumbai-2323','[\"ImpJobButton\"]',3),(30,'Seawave Forwarding Logistics','seawave@2323','Import Job Creation','hemang@executive','Jogbani','Jogbani-2323','[\"ImpJobButton\"]',5),(35,'Seawave Forwarding Logistics','seawave@2323','Organization Creation','hemang@executive','Mumbai','Mumbai-2323','[\"OrgButton\"]',9),(38,'Seawave Forwarding Logistics','seawave@2323','Export Job Creation','hemang@executive','Mumbai','Mumbai-2323','[\"ExpJobButton\"]',8);
...
) ENGINE=InnoDB AUTO_INCREMENT=230 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is the branches table that are linked to organizations';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `collection` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_as_ci COMMENT='collection table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `employees` VALUES ('hemang@executive','12345','seawave@2323','Seawave Forwarding Logistics',1,'Hemang Ranjan','executive'),('rishi@manager','345345','seawave@2323','Seawave Forwarding Logistics',2,'Rishi Mishra','manager'),('aayush@manager','12345','seawave@2323','Seawave Forwarding Logistics',3,'Aayush Mishra','manager'),('ved@manager','12345','seatech@23','seatech',11,'vedant','manager'),('sanjeet@Developer','1212','seawave@2323','Seawave Forwarding Logistics',12,'sanjeet','Developer');
...
CREATE TABLE `impnotifications` (
  ...
  `username` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store import notifications ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lob` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='line of business table as per users prefrences';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `lob` VALUES (15,'Air IMPORT','Seawave Forwarding Logistics','seawave@2323','Air',0,NULL,NULL,NULL,NULL,NULL),(16,'Sea IMPORT','Seawave Forwarding Logistics','seawave@2323','Sea',0,NULL,NULL,NULL,NULL,NULL),(17,'Air EXPORT','Seawave Forwarding Logistics','seawave@2323','Air',0,NULL,NULL,NULL,NULL,NULL),(30,'Air Import','seatech','seatech@23','Air',0,NULL,NULL,NULL,NULL,NULL),(38,'Sea EXPORT','Seawave Forwarding Logistics','seawave@2323','Sea',0,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `milestone` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=93 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table contains all the milestones';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `milestone` VALUES (49,'ETA','Air IMPORT','Seawave Forwarding Logistics','seawave@2323','Mumbai',0,'',NULL,NULL,NULL,NULL),(50,'E-SANCHIT','Air IMPORT','Seawave Forwarding Logistics','seawave@2323','Mumbai',0,'',NULL,NULL,NULL,NULL),(51,'PORT CFS NOMINATION','Air IMPORT','Seawave Forwarding Logistics','seawave@2323','Mumbai',0,'',NULL,NULL,NULL,NULL),(52,'processing','Air IMPORT','Seawave Forwarding Logistics','seawave@2323','Mumbai',0,'',NULL,NULL,NULL,NULL),(53,'ETA','Air EXPORT','Seawave Forwarding Logistics','seawave@2323','Delhi',0,'',NULL,NULL,NULL,NULL),(54,'E-SANCHIT','Air EXPORT','Seawave Forwarding Logistics','seawave@2323','Delhi',0,'',NULL,NULL,NULL,NULL),(55,'ETA','Air EXPORT','Seawave Forwarding Logistics','seawave@2323','Mumbai',0,'',NULL,NULL,NULL,NULL),(56,'ETA ','Sea EXPORT','Seawave Forwarding Logistics','seawave@2323','Mumbai',0,'',NULL,NULL,NULL,NULL),(57,'E-SANCHIT','Air EXPORT','Seawave Forwarding Logistics','seawave@2323','Mumbai',0,'',NULL,NULL,NULL,NULL),(58,'E-SANCHIT','Sea EXPORT','Seawave Forwarding Logistics','seawave@2323','Mumbai',0,'',NULL,NULL,NULL,NULL),(59,'Scanning ','Air IMPORT','Seawave Forwarding Logistics','seawave@2323','Mumbai',0,'',NULL,NULL,NULL,NULL),(60,'Packaging','Air IMPORT','Seawave Forwarding Logistics','seawave@2323','Mumbai',0,'',NULL,NULL,NULL,NULL),(61,'ETA ','Air IMPORT','Seawave Forwarding Logistics','seawave@2323','Kolkata',0,'',NULL,NULL,NULL,NULL),(62,'PORT CFS','Air IMPORT','Seawave Forwarding Logistics','seawave@2323','Kolkata',0,'',NULL,NULL,NULL,NULL),(63,'ETA','Air IMPORT','Seawave Forwarding Logistics','seawave@2323','Jogbani',0,'',NULL,NULL,NULL,NULL),(64,'E-SANCHIT','Air IMPORT','Seawave Forwarding Logistics','seawave@2323','Jogbani',0,'',NULL,NULL,NULL,NULL),(65,'PORT  CFS','Air IMPORT','Seawave Forwarding Logistics','seawave@2323','Jogbani',0,'',NULL,NULL,NULL,NULL),(71,'ETA','Air IMPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL),(72,'REX','Air IMPORT','Seawave Forwarding Logistics','seawave@2323','Delhi',0,'',NULL,NULL,NULL,NULL),(73,'PORT CFS NOMINATION','Air IMPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL),(74,'DHH','Air IMPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL),(75,'CUSTOM CLEAREANCE','Air IMPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL),(76,'ETA EXPORT ALL','Air EXPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL),(77,'test','Air Import','seatech','seatech@23','Mumbai',0,'',NULL,NULL,NULL,NULL),(78,'test2','Air Import','seatech','seatech@23','Mumbai',0,'',NULL,NULL,NULL,NULL),(79,'Test','Air IMPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL),(80,'Test','Air IMPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL),(81,'IGM & ETA Details','Sea IMPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL),(82,'Scrutiny Documents','Sea IMPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL),(83,'Checklist Preparation','Sea IMPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL),(84,'E-Sanchit','Sea IMPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL),(85,'Filling BOE','Sea IMPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL),(86,'Assessment','Sea IMPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL),(87,'Delivery Order','Sea IMPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL),(88,'Delivery','Sea IMPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL),(89,'Vehicle Placed','Sea IMPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL),(90,'Bill Preparation','Sea IMPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL),(91,'Bill Dispatch','Sea IMPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL),(92,'POD Confirmation','Sea IMPORT','Seawave Forwarding Logistics','seawave@2323','ALL',0,'',NULL,NULL,NULL,NULL);
...
CREATE TABLE `reminders` (
  ...
  `jobnumber` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=161 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store reminders for import';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `setworkflow` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table consists of all the detailed data of the particular workflow as per line of business';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transactionhistory` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='it will store all transaction dr and cr related to that job number ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `workflow` (
  ...
  `Date` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store the workflow rows ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `workflow` VALUES (1,'Air IMPORT','Mumbai','Seawave Forwarding Logistics','seawave@2323','ALL','admin','admin',0,NULL,NULL,NULL),(4,'Air EXPORT','Mumbai','Seawave Forwarding Logistics','seawave@2323','ALL','admin','admin',0,NULL,NULL,NULL),(9,'Sea IMPORT','All','Seawave Forwarding Logistics','seawave@2323','ALL','admin','admin',0,NULL,NULL,NULL);
...
-- Dump completed on 2025-04-11 17:03:39
