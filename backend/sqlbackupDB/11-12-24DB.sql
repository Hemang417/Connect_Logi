...
INSERT INTO `approvalorg` VALUES ('allcargo','India','Kerala','Cherpulassery','400057','8104834173','rishi.seawave@gmail.com','AAICS7836D','27AAICS7836D1Z','AAICS7836D','67','sadadd adeqad','seawave@2323','Seawave Forwarding Logistics','Allcargo Pvt Ltd','mumbai','admin',1,'OrgButton',NULL,'2024-12-06 17:11:27',0,NULL,NULL,'[\"Shippers\", \"Agent\", \"Carrier\", \"Global\"]','[\"Transport\", \"Import\"]','[{\"email\": \"shreyashpingle752@gmail.com\", \"mobile\": \"8655997678\", \"department\": \"IT\", \"contactName\": \"vedant\", \"designation\": \"frontend\"}]'),('adani','India','Maharashtra','Andheri','400006','9876543210','example@example.com','AAICS7836D','27AAICS7836D1Z3','AAICS7836D','45','sdaf sfswf','seawave@2323','Seawave Forwarding Logistics','adani pvt ltd','mumbai','admin',2,'OrgButton',NULL,'2024-12-06 17:13:39',0,NULL,NULL,'[\"Carrier\", \"Consignee\", \"Agent\"]','[\"Import\", \"Export\", \"Freight\", \"Transport\"]','[{\"email\": \"rishi.seawave@gmail.com\", \"mobile\": \"8655997299\", \"department\": \"IT\", \"contactName\": \"rishi\", \"designation\": \"executive\"}]'),('tray','India','Bihar','Bakhtiyarpur','400004','9876543219','shreyashpingle752@gmail.com','AAICS7836D','27AAICS7836D1Z3','AAICS7836D','45','werwe wfqwfa afsa faasfa f','seawave@2323','Seawave Forwarding Logistics','Tray ltd pvt','Bihar','admin',3,'OrgButton',NULL,'2024-12-09 11:09:40',0,NULL,NULL,'[\"Shippers\", \"Consignee\", \"Carrier\", \"Global\", \"Agent\"]','[\"Import\", \"Freight\", \"Export\"]','[{\"email\": \"shreyashpingle752@gmail.com\", \"mobile\": \"8655997299\", \"department\": \"IT\", \"contactName\": \"rishi\", \"designation\": \"frontend\"}, {\"email\": \"shreyashpingle752@gmail.com\", \"mobile\": \"8655997299\", \"department\": \"dadsda\", \"contactName\": \"ddada\", \"designation\": \"executive\"}]'),('vedant','Albania','Durrës District','Rrethi i Krujës','400057','9578907467','dean@aew.in','AAICS7836D','27AAICS7836D1Z3','AAICS7836D','45','sgsgsgs','seawave@2323','Seawave Forwarding Logistics','vedant  ltd pvt','vapi','admin',4,'OrgButton',NULL,'2024-12-09 11:11:12',0,NULL,NULL,'[\"Agent\", \"Shippers\"]','[\"Export\", \"Freight\"]','[{\"email\": \"dean@aew.in\", \"mobile\": \"gsggs\", \"department\": \"head\", \"contactName\": \"rishi\", \"designation\": \"executive\"}]'),('continental','India','Maharashtra','Navi Mumbai','400614','','','GDMPM3914G','27GDMPM3914G1Z4','GDMPM3914G','60','PANVEL','seawave@2323','Seawave Forwarding Logistics','CONTINENTAL CFS','NHAVA SHEVA','admin',5,'OrgButton',NULL,'2024-12-10 17:22:08',0,NULL,NULL,'[\"Shippers\", \"Agent\", \"Consignee\", \"Carrier\", \"Services\", \"Global\"]','[\"Import\", \"Transport\", \"Export\", \"Freight\"]','[{\"email\": \"sofsfds@gmail.com\", \"mobile\": \"5453353456\", \"department\": \"dasd\", \"contactName\": \"sdad\", \"designation\": \"dasd\"}]'),('relience','India','Maharashtra','Andheri','400058','5534667457','relience@.in','AAICS7836D','27AAICS7836D1Z3','AAICS7836D','68','Mumbai Andheri West ','seawave@2323','Seawave Forwarding Logistics','Relience Ltd','Andheri','admin',6,'OrgButton',NULL,'2024-12-11 12:23:15',0,NULL,NULL,'[\"Consignee\", \"Carrier\", \"Global\"]','[\"Import\", \"Transport\", \"Freight\"]','[{\"email\": \"sofsfds@gmail.com\", \"mobile\": \"8655997299\", \"department\": \"head\", \"contactName\": \"anant\", \"designation\": \"executive\"}]');
...
) ENGINE=InnoDB AUTO_INCREMENT=129 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is the branches table that are linked to organizations';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notifications` (
  ...
  `createdat` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store notifications and its data';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-12-11 16:37:47
