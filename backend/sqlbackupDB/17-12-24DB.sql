...
CREATE TABLE `credit` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_as_ci COMMENT='credit details are store in this table ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transactionhistory` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='it will store all transaction dr and cr related to that job number ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `transactionhistory` VALUES (6,'A/Mumbai/E/24-25/6','2024-12-17 00:00:00','against-bill','403','65392.00','0','Seawave Forwarding Logistics','seawave@2323','Mumbai'),(7,'A/Mumbai/E/24-25/5','2024-12-17 00:00:00','against-bill','403','10900.00','0','Seawave Forwarding Logistics','seawave@2323','Mumbai'),(8,'A/Mumbai/E/24-25/6','2024-12-20 00:00:00','fjfsdksf','42565565','0','10000.00','Seawave Forwarding Logistics','seawave@2323','Mumbai'),(9,'A/Mumbai/E/24-25/6','2024-12-21 00:00:00','food','42565565','0','1020.00','Seawave Forwarding Logistics','seawave@2323','Mumbai');
...
-- Dump completed on 2024-12-17 17:42:45
