...
INSERT INTO `delegations` VALUES ('admin','rishi@manager','Mumbai','Mumbai-2323','2025-06-06 00:00:00','2',7,'asasas','seawave@2323','Seawave Forwarding Logistics','asasas','2025-06-04 17:57:14','2025-06-04 17:57:21','admin','Delayed','asasas',0,NULL,NULL,NULL),('admin','hemang@executive','Mumbai','Mumbai-2323','2025-06-06 00:00:00','12',8,'12qs3qwdqwd','seawave@2323','Seawave Forwarding Logistics','asasasas','2025-06-04 18:03:06','2025-06-04 18:03:51','hemang@executive','Delayed','done',0,NULL,NULL,NULL),('admin','hemang@executive','Mumbai','Mumbai-2323','2025-06-07 00:00:00','23',9,'1232r3qewddcsf','seawave@2323','Seawave Forwarding Logistics','Zasas','2025-06-04 18:08:04','2025-06-04 18:16:19','hemang@executive','Completed','testing remark',0,NULL,NULL,NULL),('admin','hemang@executive','Mumbai','Mumbai-2323','2025-06-07 00:00:00','23',10,'test','seawave@2323','Seawave Forwarding Logistics','testing','2025-06-04 18:18:19','2025-06-04 18:18:51','hemang@executive','Completed','dfdfdf',0,NULL,NULL,NULL),('admin','hemang@executive','Mumbai','Mumbai-2323','2025-06-06 00:00:00','1',11,'asdfdgdbgf','seawave@2323','Seawave Forwarding Logistics','asas','2025-06-05 10:52:34','2025-06-05 10:53:52','hemang@executive','Completed','11111',1,'asas','2025-06-05 11:56:46','admin'),('admin','hemang@executive','Mumbai','Mumbai-2323','2025-06-12 00:00:00','2323',13,'sdfvsdfvdfvsdfvsdfvsdfvdfv','seawave@2323','Seawave Forwarding Logistics','qwqwqw','2025-06-05 12:04:11',NULL,NULL,'pending',NULL,0,NULL,NULL,NULL);
...
CREATE TABLE `lob` (
  ...
  `deletedby` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='line of business table as per users prefrences';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `lob` VALUES (15,'IMPORT','Seawave Forwarding Logistics','seawave@2323','Air',0,NULL,NULL,NULL,NULL,NULL),(16,'IMPORT','Seawave Forwarding Logistics','seawave@2323','Sea',0,NULL,NULL,NULL,NULL,NULL),(17,'EXPORT','Seawave Forwarding Logistics','seawave@2323','Air',0,NULL,NULL,NULL,NULL,NULL),(30,'Import','seatech','seatech@23','Air',0,NULL,NULL,NULL,NULL,NULL),(38,'EXPORT','Seawave Forwarding Logistics','seawave@2323','Sea',0,NULL,NULL,NULL,NULL,NULL),(39,'dadada','Seawave Forwarding Logistics','seawave@2323','Air',1,'test','2025-06-06 00:00:00','2025-04-03','admin','admin'),(40,'test','Seawave Forwarding Logistics','seawave@2323','Sea',0,NULL,NULL,'2025-04-04','admin','admin'),(41,'asas','Seawave Forwarding Logistics','seawave@2323','Air',0,NULL,NULL,'2025-05-06','admin','admin'),(42,'final test','Seawave Forwarding Logistics','seawave@2323','Sea',0,NULL,NULL,'2025-06-06','admin',NULL),(43,'test 2','Seawave Forwarding Logistics','seawave@2323','Sea',0,NULL,NULL,'2025-06-06','admin',NULL),(44,'test3 ','Seawave Forwarding Logistics','seawave@2323','Air',0,NULL,NULL,'2025-06-06','admin',NULL),(45,'dfg ','Seawave Forwarding Logistics','seawave@2323','Air',0,NULL,NULL,'2025-06-06','admin',NULL),(46,'dfg ','Seawave Forwarding Logistics','seawave@2323','Air',0,NULL,NULL,'2025-06-06','admin',NULL),(47,'Name test','Seawave Forwarding Logistics','seawave@2323','Air',0,NULL,NULL,'2025-06-06','admin',NULL);
...
INSERT INTO `messages` VALUES (1,'Seawave Forwarding Logistics','seawave@2323',1,15,'hii','2025-06-03 13:02:31'),(2,'Seawave Forwarding Logistics','seawave@2323',1,15,'hii','2025-06-04 05:58:37'),(3,'Seawave Forwarding Logistics','seawave@2323',1,15,'wqll','2025-06-04 06:09:14'),(4,'Seawave Forwarding Logistics','seawave@2323',1,5,'sasas','2025-06-04 07:04:26'),(5,'Seawave Forwarding Logistics','seawave@2323',4,15,'Test','2025-06-04 10:16:34'),(6,'Seawave Forwarding Logistics','seawave@2323',4,5,'Sanjeet','2025-06-04 10:17:18'),(7,'Seawave Forwarding Logistics','seawave@2323',4,5,'dsdad','2025-06-04 10:58:03'),(8,'Seawave Forwarding Logistics','seawave@2323',4,6,'aayush','2025-06-04 11:28:27'),(9,'Seawave Forwarding Logistics','seawave@2323',4,5,'sanjeet','2025-06-04 11:42:31'),(10,'Seawave Forwarding Logistics','seawave@2323',5,6,'he','2025-06-04 11:43:09'),(11,'Seawave Forwarding Logistics','seawave@2323',5,15,'sasa','2025-06-04 11:43:19');
...
CREATE TABLE `transactionhistory` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=117 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='it will store all transaction dr and cr related to that job number ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-06-09 10:34:06
