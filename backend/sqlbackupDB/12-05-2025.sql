...
CREATE TABLE `customjobnumber` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=292 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store the custom job number';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ownbranches` VALUES (6,'seawave@2323','Seawave Forwarding Logistics','Mumbai','27AAICS7836D1Z4','AAICS7836D','N .K. MISHRA','7654334323','Juinagar 2.0','Mumbai-2323',0,NULL,NULL,NULL,NULL,NULL),(7,'seawave@2323','Seawave Forwarding Logistics','Jogbani','27GDMPM3914G1Z4','GDMPM3914G','Aryan','98657451222','gjkjsof kdsf fsdfj dffksf kldhnf','Jogbani-2323',0,NULL,NULL,NULL,NULL,NULL),(8,'seawave@2323','Seawave Forwarding Logistics','Delhi','27GDMPM3914G1Z4','GDMPM3914G','Rishi','98657451222','sdfdfsf vsdds','Delhi-2323',0,NULL,NULL,NULL,NULL,NULL),(10,'seatech@23','seatech','Mumbai','27AAICS7836D1Z4','AAICS7836D','kea','345345634','dssd dad','Mumbai-23',0,NULL,NULL,NULL,NULL,NULL),(16,'seawave@2323','Seawave Forwarding Logistics','Dharashiv','1222','1212','Aryan','12122','1212','Dharashiv-2323',1,'admin',NULL,'asasas','2025-05-09 00:00:00',NULL),(17,'seawave@2323','Seawave Forwarding Logistics','testing','1212','1212','1212','1212','testing','testing-2323',1,'admin',NULL,'asas','2025-05-09 00:00:00',NULL),(20,'seawave@2323','Seawave Forwarding Logistics','jaisalmer','1212','122','1212','1212','rajasthan','jaisalmer-2323',0,'admin','admin',NULL,NULL,NULL),(21,'seawave@2323','Seawave Forwarding Logistics','qwqw','qwqw','qwqw','qwq','qwqw','qwqw','qwqw-2323',1,'admin','admin','testing','2025-05-12 00:00:00',NULL);
...
CREATE TABLE `transactionhistory` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=92 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='it will store all transaction dr and cr related to that job number ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store data of user';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `userkyctable` VALUES (5,'Sanjeet','sanjeet@Developer','2004263507','2004263507','jai@323gmail.in','jai@323gmail.in','213456787678945','SAMJ2354J','2025-07-01','2001-02-28','Seawave Forwarding Logistics','seawave@2323','[{\"branchcode\": \"Mumbai-2323\", \"ownbranchname\": \"Mumbai\"}, {\"branchcode\": \"Jogbani-2323\", \"ownbranchname\": \"Jogbani\"}, {\"branchcode\": \"Jogbani-2323\", \"ownbranchname\": \"Jogbani\"}, {\"branchcode\": \"Mumbai-2323\", \"ownbranchname\": \"Mumbai\"}]','/uploads/kyc/kyc-1747028439762-538380557.png'),(6,'Aayush Mishra','aayush@manager','9632587410','9512364780','aayush@323gmail.in','aayush@323gmail.in','213456787678945','SAMJ2354J','2023-08-30','2000-02-04','Seawave Forwarding Logistics','seawave@2323','[{\"branchcode\": \"Mumbai-2323\", \"ownbranchname\": \"Mumbai\"}, {\"branchcode\": \"Jogbani-2323\", \"ownbranchname\": \"Jogbani\"}, {\"branchcode\": \"Delhi-2323\", \"ownbranchname\": \"Delhi\"}, {\"branchcode\": \"Kolkata-2323\", \"ownbranchname\": \"Kolkata\"}]','/uploads/kyc/kyc-1747048040459-308283390.jpg'),(15,'Hemang','hemang@executive','02004263507','02004263507','jai@323gmail.in','jai@323gmail.in','980734561234','SAMJ2354J','2025-05-16','2025-05-08','Seawave Forwarding Logistics','seawave@2323','[{\"branchcode\": \"Jogbani-2323\", \"ownbranchname\": \"Jogbani\"}, {\"branchcode\": \"Delhi-2323\", \"ownbranchname\": \"Delhi\"}]','/uploads/kyc/kyc-1747051871850-435015512.jpg');
...
-- Dump completed on 2025-05-12 18:17:06
