...
CREATE TABLE `approvername` (
  ...
  `createdAt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=107 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store all the names of users for a particular approval list';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `credit` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_as_ci COMMENT='credit details are store in this table ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `debit` VALUES (1,'2024-12-20',NULL,'N/A','new car purchase','Allcargo Pvt Ltd','100','118.00','18.00','1.00','117.00','45643663','Export','A/Mumbai/E/24-25/6','adani','gdgdggg','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323'),(2,'2024-12-26',NULL,'ICICI','tye of ecoosdf','Prince','100000','100000.00','0.00','2000.00','98000.00','42565565','Import','A/Mumbai/I/24-25/2','Tray ltd pvt','jskjkj','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323'),(3,'2024-12-13',NULL,'N/A','tye of ecoosdf','Gondya','100000','105000.00','5000.00','10000.00','95000.00','42565565','Export','A/Mumbai/E/24-25/1','','jskjkj','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323'),(4,'2024-12-06',NULL,'N/A','pen','Digga D','100','128.00','28.00','0.00','128.00','55325235525','Import','S/Mumbai/I/24-25/4','','jskjkj','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323'),(5,'2024-12-20',NULL,'ICICI','tye of ecoosdf','Prince','100','118.00','18.00','0.00','118.00','42565565','Import','A/Mumbai/I/24-25/3','Tray ltd pvt','asdaddasd','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323'),(6,'2024-12-27',NULL,'N/A','new laptop','Digga D','1000','1000.00','0.00','0.00','1000.00','345345354','Export','A/Mumbai/E/24-25/2','Allcargo Pvt Ltd','ggssdf','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323'),(7,'2024-12-18',NULL,'N/A','tye of ecoosdf','Allcargo Pvt Ltd','1000','1000.00','0.00','0.00','1000.00','34535453','Import','A/Mumbai/I/24-25/1','vedant  ltd pvt','gdg','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323'),(8,'2024-12-27',NULL,'Canara','tye of ecoosdf','Gondya','10000','10000.00','0.00','0.00','10000.00','979686','Import','A/Mumbai/I/24-25/13','adani pvt ltd','dfhhd','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323'),(9,'2025-01-08',NULL,'Canara','new computer','Gondya','1000','1050.00','50.00','100.00','950.00','46546566','Import','A/Mumbai/I/24-25/15','Allcargo Pvt Ltd','gyuh','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323'),(10,'2025-05-17',NULL,'ICICI','tye of ecoosdf','Gondya','100','112.00','12.00','5.00','107.00','uihuyh','Import','A/Mumbai/I/24-25/2','Tray ltd pvt','sfskdgfsju','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323'),(11,'2025-05-17',NULL,'SBI','pen','Gondya','100','105.00','5.00','5.00','100.00','54454546','Import','A/Mumbai/I/24-25/2','Tray ltd pvt','000','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323'),(12,'2025-05-18',NULL,'ICICI','new laptop','Allcargo Pvt Ltd','100000','128000.00','28000.00','5000.00','123000.00','54454546','Export','A/Mumbai/E/24-25/2','adani pvt ltd','sfskdgfsju','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323'),(14,'2025-05-28','Mumbai/DR/25-26/8','ICICI','new car purchase','Gondya','1000','1050.00','50.00','50.00','1000.00','qqaswe','Import','A/Mumbai/I/24-25/3','Tray ltd pvt','wasfre','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323');
...
-- Dump completed on 2025-05-29 16:50:24
