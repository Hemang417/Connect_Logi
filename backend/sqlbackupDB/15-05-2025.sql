...
CREATE TABLE `adminchangeapproval` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='if password is change before updating it should go for admin approval';
...
INSERT INTO `adminchangeapproval` VALUES (4,'hemang@executive','executive','12345','Approved','bhul gya password','seawave2323','2024-09-20 12:19:35'),(6,'Aryan','developer','1212','Approved','bhul gya password','seawave@2323','2025-04-02 11:46:28');
...
CREATE TABLE `approvalimpjob` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store approvaljob before actually approving or rejecting';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `approverlist` (
  ...
  `DeletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store the name of the approver list of a particular organization';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `approverlist` VALUES ('Seawave Forwarding Logistics','seawave@2323',5,'Import Job Creation','Mumbai','Mumbai-2323','[\"ImpJobButton\"]',1,NULL,1,'admin',NULL,'zxzx','2025-05-12 00:00:00'),('Seawave Forwarding Logistics','seawave@2323',9,'Organization Creation','Delhi','Delhi-2323','[\"OrgButton\"]',1,NULL,0,NULL,NULL,NULL,NULL),('Seawave Forwarding Logistics','seawave@2323',10,'Organization Creation','Jogbani','Jogbani-2323','[\"OrgButton\"]',1,NULL,0,NULL,NULL,NULL,NULL),('Seawave Forwarding Logistics','seawave@2323',11,'Export Job Creation','Mumbai','Mumbai-2323','[\"ExpJobButton\"]',1,NULL,0,NULL,NULL,NULL,NULL),('Seawave Forwarding Logistics','seawave@2323',12,'Export Job Creation','Delhi','Delhi-2323','[\"ExpJobButton\"]',0,NULL,0,NULL,NULL,NULL,NULL),('Seawave Forwarding Logistics','seawave@2323',14,'test','Mumbai','Mumbai-2323','[\"ImportBtn\"]',1,'2025-05-12 09:53:35',1,'admin','admin','asas','2025-05-12 00:00:00');
...
CREATE TABLE `approvername` (
  ...
  `createdAt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store all the names of users for a particular approval list';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `approvername` VALUES (30,'Seawave Forwarding Logistics','seawave@2323','Import Job Creation','hemang@executive','Mumbai','Mumbai-2323','[\"ImpJobButton\"]',5,1,'admin',NULL,'zxzx','2025-05-12 00:00:00',NULL),(36,'Seawave Forwarding Logistics','seawave@2323','Organization Creation','hemang@executive','Jogbani','Jogbani-2323','[\"OrgButton\"]',10,0,NULL,NULL,NULL,NULL,NULL),(39,'Seawave Forwarding Logistics','seawave@2323','Export Job Creation','aayush@manager','Jogbani','Jogbani-2323','[\"ExpJobButton\"]',11,0,NULL,NULL,NULL,NULL,NULL),(66,'Seawave Forwarding Logistics','seawave@2323','Organization Creation','aayush@manager','Mumbai','Mumbai-2323','[\"OrgButton\"]',9,0,NULL,NULL,NULL,NULL,NULL),(68,'Seawave Forwarding Logistics','seawave@2323','test','aayush@manager','Mumbai','Mumbai-2323','[\"ImportBtn\"]',14,1,'admin',NULL,'asas','2025-05-12 00:00:00',NULL);
...
CREATE TABLE `branchaccess` (
  ...
  `orgcode` varchar(150) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is for access of users for their org branches ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `branchaccess` VALUES (8,'Jogbani','Jogbani-2323','hemang@executive','Seawave Forwarding Logistics','seawave@2323'),(9,'Jogbani','Jogbani-2323','aayush@manager','Seawave Forwarding Logistics','seawave@2323'),(11,'Delhi','Delhi-2323','aayush@manager','Seawave Forwarding Logistics','seawave@2323'),(12,'Delhi','Delhi-2323','hemang@executive','Seawave Forwarding Logistics','seawave@2323'),(15,'Jogbani','Jogbani-2323','rishi@manager','Seawave Forwarding Logistics','seawave@2323'),(16,'Delhi','Delhi-2323','rishi@manager','Seawave Forwarding Logistics','seawave@2323'),(18,'Mumbai','Mumbai-23','ved@manager','seatech','seatech@23'),(25,'Mumbai','Mumbai-2323','aayush@manager','Seawave Forwarding Logistics','seawave@2323');
...
CREATE TABLE `credit` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_as_ci COMMENT='credit details are store in this table ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `customjobnumber` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=297 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store the custom job number';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `customrefnumber` VALUES (7,'Seawave Forwarding Logistics','seawave@2323','Ref No.','Jogbani','Jogbani-2323',NULL),(8,'Seawave Forwarding Logistics','seawave@2323','Fiscal Year','Jogbani','Jogbani-2323',NULL),(9,'Seawave Forwarding Logistics','seawave@2323','Branch Name','Jogbani','Jogbani-2323',NULL),(26,'Seawave Forwarding Logistics','seawave@2323','Fiscal Year','Kolkata','Kolkata-2323',NULL),(27,'Seawave Forwarding Logistics','seawave@2323','Ref No.','Kolkata','Kolkata-2323',NULL),(28,'Seawave Forwarding Logistics','seawave@2323','Branch Name','Kolkata','Kolkata-2323',NULL),(29,'Seawave Forwarding Logistics','seawave@2323','KB','Kolkata','Kolkata-2323','KB'),(30,'Seawave Forwarding Logistics','seawave@2323','Branch Name','Mumbai','Mumbai-2323',NULL),(31,'Seawave Forwarding Logistics','seawave@2323','Fiscal Year','Mumbai','Mumbai-2323',NULL),(32,'Seawave Forwarding Logistics','seawave@2323','Ref No.','Mumbai','Mumbai-2323',NULL);
...
INSERT INTO `employees` VALUES ('hemang@executive','12345','seawave@2323','Seawave Forwarding Logistics',1,'Hemang Ranjan','executive'),('rishi@manager','345345','seawave@2323','Seawave Forwarding Logistics',2,'Rishi Mishra','manager'),('aayush@manager','12345','seawave@2323','Seawave Forwarding Logistics',3,'Aayush Mishra','manager'),('ved@manager','12345','seatech@23','seatech',11,'vedant','manager'),('sanjeet@Developer','12345','seawave@2323','Seawave Forwarding Logistics',12,'sanjeet','Developer'),('Aryan@Developer','1212','seawave@2323','Seawave Forwarding Logistics',32,'Aryan Rajesh Shinde','Developer');
...
CREATE TABLE `impnotifications` (
  ...
  `username` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store import notifications ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transactionhistory` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=108 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='it will store all transaction dr and cr related to that job number ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store data of user';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `userkyctable` VALUES (5,'Sanjeet Sawardekar','sanjeet@Developer','2004263507','2004263507','jai@323gmail.in','jai@323gmail.in','213456787678945','SAMJ2354J','2025-07-01','2001-02-28','Seawave Forwarding Logistics','seawave@2323','[]','/uploads/kyc/kyc-1747028439762-538380557.png'),(6,'Aayush Mishra','aayush@manager','9632587410','9512364780','aayush@323gmail.in','aayush@323gmail.in','213456787678945','SAMJ2354J','2023-08-30','2000-02-04','Seawave Forwarding Logistics','seawave@2323','[{\"branchcode\": \"Mumbai-2323\", \"ownbranchname\": \"Mumbai\"}, {\"branchcode\": \"Jogbani-2323\", \"ownbranchname\": \"Jogbani\"}, {\"branchcode\": \"Delhi-2323\", \"ownbranchname\": \"Delhi\"}, {\"branchcode\": \"Kolkata-2323\", \"ownbranchname\": \"Kolkata\"}]','/uploads/kyc/kyc-1747048040459-308283390.jpg'),(15,'Hemang','hemang@executive','02004263507','02004263507','jai@323gmail.in','jai@323gmail.in','980734561234','SAMJ2354J','2025-05-16','2025-05-08','Seawave Forwarding Logistics','seawave@2323','[{\"branchcode\": \"Jogbani-2323\", \"ownbranchname\": \"Jogbani\"}, {\"branchcode\": \"Delhi-2323\", \"ownbranchname\": \"Delhi\"}]','/uploads/kyc/kyc-1747051871850-435015512.jpg');
...
-- Dump completed on 2025-05-15 14:24:46
