...
INSERT INTO `accesscontrol` VALUES (41,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','ORGANIZATION','download-client','admin'),(43,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','ORGANIZATION','delete-client','admin'),(49,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Jogbani','Jogbani-2323','EXPORT','add-job','admin'),(50,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Jogbani','Jogbani-2323','EXPORT','delete-job','admin'),(67,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','IMPORT','add-job','admin'),(68,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','IMPORT','delete-job','admin'),(69,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','IMPORT','download-job','admin'),(84,'hemang@executive','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','ORGANIZATION','add-client','admin');
...
CREATE TABLE `approvername` (
  ...
  `createdAt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=97 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store all the names of users for a particular approval list';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `branchaccess` (
  ...
  `IsDeleted` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is for access of users for their org branches ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `branchaccess` VALUES (8,'Jogbani','Jogbani-2323','hemang@executive','Seawave Forwarding Logistics','seawave@2323',0),(9,'Jogbani','Jogbani-2323','aayush@manager','Seawave Forwarding Logistics','seawave@2323',0),(11,'Delhi','Delhi-2323','aayush@manager','Seawave Forwarding Logistics','seawave@2323',0),(12,'Delhi','Delhi-2323','hemang@executive','Seawave Forwarding Logistics','seawave@2323',0),(15,'Jogbani','Jogbani-2323','rishi@manager','Seawave Forwarding Logistics','seawave@2323',0),(16,'Delhi','Delhi-2323','rishi@manager','Seawave Forwarding Logistics','seawave@2323',0),(18,'Mumbai','Mumbai-23','ved@manager','seatech','seatech@23',0),(25,'Mumbai','Mumbai-2323','aayush@manager','Seawave Forwarding Logistics','seawave@2323',0),(26,'Mumbai','Mumbai-2323','hemang@executive','Seawave Forwarding Logistics','seawave@2323',0);
...
CREATE TABLE `customjobnumber` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=300 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store the custom job number';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `customrefnumber` VALUES (7,'Seawave Forwarding Logistics','seawave@2323','Ref No.','Jogbani','Jogbani-2323',NULL),(8,'Seawave Forwarding Logistics','seawave@2323','Fiscal Year','Jogbani','Jogbani-2323',NULL),(9,'Seawave Forwarding Logistics','seawave@2323','Branch Name','Jogbani','Jogbani-2323',NULL),(30,'Seawave Forwarding Logistics','seawave@2323','Branch Name','Mumbai','Mumbai-2323',NULL),(31,'Seawave Forwarding Logistics','seawave@2323','Fiscal Year','Mumbai','Mumbai-2323',NULL),(32,'Seawave Forwarding Logistics','seawave@2323','Ref No.','Mumbai','Mumbai-2323',NULL),(33,'Seawave Forwarding Logistics','seawave@2323','Fiscal Year','Kolkata','Kolkata-2323',NULL),(34,'Seawave Forwarding Logistics','seawave@2323','Ref No.','Kolkata','Kolkata-2323',NULL),(35,'Seawave Forwarding Logistics','seawave@2323','Branch Name','Kolkata','Kolkata-2323',NULL);
...
CREATE TABLE `debit` (
  ...
  `branchcode` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store debit payment sheet';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transactionhistory` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=112 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='it will store all transaction dr and cr related to that job number ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store data of user';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `userkyctable` VALUES (5,'Sanjeet Sawardekar','sanjeet@Developer','2004263507','2004263507','jai@323gmail.in','jai@323gmail.in','213456787678945','SAMJ2354J','2025-07-01','2001-02-28','Seawave Forwarding Logistics','seawave@2323','[]','/uploads/kyc/kyc-1747028439762-538380557.png'),(6,'Aayush Mishra','aayush@manager','9632587410','9512364780','aayush@323gmail.in','aayush@323gmail.in','213456787678945','SAMJ2354J','2023-08-30','2000-02-04','Seawave Forwarding Logistics','seawave@2323','[{\"branchcode\": \"Mumbai-2323\", \"ownbranchname\": \"Mumbai\"}, {\"branchcode\": \"Jogbani-2323\", \"ownbranchname\": \"Jogbani\"}, {\"branchcode\": \"Delhi-2323\", \"ownbranchname\": \"Delhi\"}, {\"branchcode\": \"Kolkata-2323\", \"ownbranchname\": \"Kolkata\"}]','/uploads/kyc/kyc-1747048040459-308283390.jpg'),(15,'Hemang','hemang@executive','02004263507','02004263507','jai@323gmail.in','jai@323gmail.in','980734561234','SAMJ2354J','2025-05-16','2025-05-08','Seawave Forwarding Logistics','seawave@2323','[{\"branchcode\": \"Jogbani-2323\", \"ownbranchname\": \"Jogbani\"}, {\"branchcode\": \"Delhi-2323\", \"ownbranchname\": \"Delhi\"}]','/uploads/kyc/kyc-1747391604141-991180399.jpg');
...
-- Dump completed on 2025-05-20 16:08:06
