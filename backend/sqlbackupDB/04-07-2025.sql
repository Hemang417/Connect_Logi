...
CREATE TABLE `approvalexpjob` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store approvexpjob before actually approving or rejecting';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `collection` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=84 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_as_ci COMMENT='collection table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `conversation_employees` VALUES (1,'Seawave Forwarding Logistics','seawave@2323',1,15),(2,'Seawave Forwarding Logistics','seawave@2323',1,5),(3,'Seawave Forwarding Logistics','seawave@2323',2,5),(4,'Seawave Forwarding Logistics','seawave@2323',2,6),(5,'Seawave Forwarding Logistics','seawave@2323',3,15),(6,'Seawave Forwarding Logistics','seawave@2323',3,6),(7,'Seawave Forwarding Logistics','seawave@2323',4,6),(8,'Seawave Forwarding Logistics','seawave@2323',4,5),(9,'Seawave Forwarding Logistics','seawave@2323',4,15),(10,'Seawave Forwarding Logistics','seawave@2323',5,6),(11,'Seawave Forwarding Logistics','seawave@2323',5,15);
...
INSERT INTO `conversations` VALUES (1,'Seawave Forwarding Logistics','seawave@2323',0,NULL,15,'2025-06-03 13:02:31'),(2,'Seawave Forwarding Logistics','seawave@2323',0,NULL,5,'2025-06-04 06:10:17'),(3,'Seawave Forwarding Logistics','seawave@2323',0,NULL,15,'2025-06-04 07:02:00'),(4,'Seawave Forwarding Logistics','seawave@2323',1,'Test Group',15,'2025-06-04 10:16:20'),(5,'Seawave Forwarding Logistics','seawave@2323',1,'t1',15,'2025-06-04 10:43:47');
...
CREATE TABLE `credit` (
  ...
  `deletedby` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_as_ci COMMENT='credit details are store in this table ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `delegations` VALUES ('admin','rishi@manager','Mumbai','Mumbai-2323','2025-06-06 00:00:00','2',7,'asasas','seawave@2323','Seawave Forwarding Logistics','asasas','2025-06-04 17:57:14','2025-06-04 17:57:21','admin','Delayed','asasas',0,NULL,NULL,NULL),('admin','hemang@executive','Mumbai','Mumbai-2323','2025-06-06 00:00:00','12',8,'12qs3qwdqwd','seawave@2323','Seawave Forwarding Logistics','asasasas','2025-06-04 18:03:06','2025-06-04 18:03:51','hemang@executive','Delayed','done',0,NULL,NULL,NULL),('admin','hemang@executive','Mumbai','Mumbai-2323','2025-06-07 00:00:00','23',9,'1232r3qewddcsf','seawave@2323','Seawave Forwarding Logistics','Zasas','2025-06-04 18:08:04','2025-06-04 18:16:19','hemang@executive','Delayed','testing remark',0,NULL,NULL,NULL),('admin','hemang@executive','Mumbai','Mumbai-2323','2025-06-07 00:00:00','23',10,'test','seawave@2323','Seawave Forwarding Logistics','testing','2025-06-04 18:18:19','2025-06-04 18:18:51','hemang@executive','Delayed','dfdfdf',0,NULL,NULL,NULL),('admin','hemang@executive','Mumbai','Mumbai-2323','2025-06-06 00:00:00','1',11,'asdfdgdbgf','seawave@2323','Seawave Forwarding Logistics','asas','2025-06-05 10:52:34','2025-06-05 10:53:52','hemang@executive','Completed','11111',1,'asas','2025-06-05 11:56:46','admin'),('admin','hemang@executive','Mumbai','Mumbai-2323','2025-06-12 00:00:00','2323',13,'sdfvsdfvdfvsdfvsdfvsdfvdfv','seawave@2323','Seawave Forwarding Logistics','qwqwqw','2025-06-05 12:04:11','2025-06-16 17:01:03','admin','Delayed','qwswfef',0,NULL,NULL,NULL);
...
INSERT INTO `employees` VALUES ('hemang@executive','12345','seawave@2323','Seawave Forwarding Logistics',1,'Hemang Ranjan','executive',NULL,0,NULL,NULL,NULL,NULL),('rishi@manager','345345','seawave@2323','Seawave Forwarding Logistics',2,'Rishi Mishra','manager',NULL,0,NULL,NULL,NULL,NULL),('aayush@manager','12345','seawave@2323','Seawave Forwarding Logistics',3,'Aayush Mishra','manager',NULL,0,NULL,NULL,NULL,NULL),('ved@manager','12345','seatech@23','seatech',11,'vedant','manager',NULL,0,NULL,NULL,NULL,NULL),('sanjeet@Developer','12345','seawave@2323','Seawave Forwarding Logistics',12,'sanjeet','Developer',NULL,0,NULL,NULL,NULL,NULL),('Aryan@Developer','12345','seawave@2323','Seawave Forwarding Logistics',32,'Aryan Rajesh Shinde','Developer',NULL,0,NULL,NULL,NULL,NULL);
...
CREATE TABLE `expnotifications` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store export notifications ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lob` (
  ...
  `deletedby` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='line of business table as per users prefrences';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `lob` VALUES (15,'IMPORT','Seawave Forwarding Logistics','seawave@2323','Air',0,NULL,NULL,NULL,NULL,NULL),(16,'IMPORT','Seawave Forwarding Logistics','seawave@2323','Sea',0,NULL,NULL,NULL,NULL,NULL),(17,'EXPORT','Seawave Forwarding Logistics','seawave@2323','Air',0,NULL,NULL,NULL,NULL,NULL),(30,'Import','seatech','seatech@23','Air',0,NULL,NULL,NULL,NULL,NULL),(38,'EXPORT','Seawave Forwarding Logistics','seawave@2323','Sea',0,NULL,NULL,NULL,NULL,NULL),(39,'dadada','Seawave Forwarding Logistics','seawave@2323','Air',1,'test','2025-06-06 00:00:00','2025-04-03','admin','admin'),(40,'test','Seawave Forwarding Logistics','seawave@2323','Sea',0,NULL,NULL,'2025-04-04','admin','admin'),(41,'asas','Seawave Forwarding Logistics','seawave@2323','Air',0,NULL,NULL,'2025-05-06','admin','admin'),(42,'final test','Seawave Forwarding Logistics','seawave@2323','Sea',0,NULL,NULL,'2025-06-06','admin',NULL),(43,'test 2','Seawave Forwarding Logistics','seawave@2323','Sea',0,NULL,NULL,'2025-06-06','admin',NULL),(44,'test3 ','Seawave Forwarding Logistics','seawave@2323','Air',0,NULL,NULL,'2025-06-06','admin',NULL),(45,'dfg ','Seawave Forwarding Logistics','seawave@2323','Air',0,NULL,NULL,'2025-06-06','admin',NULL),(46,'dfg ','Seawave Forwarding Logistics','seawave@2323','Air',0,NULL,NULL,'2025-06-06','admin',NULL),(47,'Name test','Seawave Forwarding Logistics','seawave@2323','Air',0,NULL,NULL,'2025-06-06','admin',NULL),(48,'test','Seawave Forwarding Logistics','seawave@2323','Air',0,NULL,NULL,'2025-06-25','admin',NULL);
...
INSERT INTO `messages` VALUES (1,'Seawave Forwarding Logistics','seawave@2323',1,15,'hii','2025-06-03 13:02:31','2025-06-18 18:03:52',NULL),(2,'Seawave Forwarding Logistics','seawave@2323',1,15,'hii','2025-06-04 05:58:37',NULL,NULL),(3,'Seawave Forwarding Logistics','seawave@2323',1,15,'wqllwerre','2025-06-04 06:09:14',NULL,NULL),(4,'Seawave Forwarding Logistics','seawave@2323',1,5,'sasassas','2025-06-04 07:04:26','2025-06-18 16:13:15',NULL),(5,'Seawave Forwarding Logistics','seawave@2323',4,15,'Test','2025-06-04 10:16:34',NULL,NULL),(6,'Seawave Forwarding Logistics','seawave@2323',4,5,'Sanjeet','2025-06-04 10:17:18',NULL,NULL),(7,'Seawave Forwarding Logistics','seawave@2323',4,5,'dsdad','2025-06-04 10:58:03',NULL,NULL),(8,'Seawave Forwarding Logistics','seawave@2323',4,6,'aayush','2025-06-04 11:28:27',NULL,NULL),(9,'Seawave Forwarding Logistics','seawave@2323',4,5,'sanjeet','2025-06-04 11:42:31',NULL,NULL),(10,'Seawave Forwarding Logistics','seawave@2323',5,6,'he','2025-06-04 11:43:09',NULL,NULL),(11,'Seawave Forwarding Logistics','seawave@2323',5,15,'sasa','2025-06-04 11:43:19',NULL,NULL),(12,'Seawave Forwarding Logistics','seawave@2323',1,5,'asas','2025-06-18 11:03:50',NULL,NULL),(13,'Seawave Forwarding Logistics','seawave@2323',1,5,'wdwadada','2025-06-18 11:03:55',NULL,NULL),(14,'Seawave Forwarding Logistics','seawave@2323',1,5,'dsas','2025-06-18 11:03:58','2025-06-25 15:44:36',NULL),(15,'Seawave Forwarding Logistics','seawave@2323',1,5,'asdadas','2025-06-18 11:04:01','2025-06-25 15:43:35',NULL),(16,'Seawave Forwarding Logistics','seawave@2323',1,5,'Hello Hemang','2025-06-26 12:17:33',NULL,NULL),(17,'Seawave Forwarding Logistics','seawave@2323',3,6,'Hello Hemang From Aayush','2025-06-26 12:18:37',NULL,NULL),(18,'Seawave Forwarding Logistics','seawave@2323',2,5,'Hello aayush Sanjeet here','2025-06-26 12:21:10',NULL,NULL),(19,'Seawave Forwarding Logistics','seawave@2323',2,5,'HASH','2025-06-26 12:22:12',NULL,NULL),(20,'Seawave Forwarding Logistics','seawave@2323',2,6,'HSAH','2025-06-26 12:23:12',NULL,NULL);
...
CREATE TABLE `ownbranches` (
  ...
  `createdAt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table consists of the data of the branches of the organization.\n    ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ownbranches` VALUES (6,'seawave@2323','Seawave Forwarding Logistics','Mumbai','27AAICS7836D1Z4','N .K. MISHRA','7654334323',NULL,NULL,NULL,'Juinagar 2.0',NULL,'Mumbai-2323',0,NULL,NULL,NULL,NULL,NULL),(7,'seawave@2323','Seawave Forwarding Logistics','Jogbani','27GDMPM3914G1Z4','Hemang','98657451222',NULL,NULL,NULL,'gjkjsof kdsf fsdfj dffksf kldhnf',NULL,'Jogbani-2323',0,NULL,NULL,NULL,NULL,NULL),(8,'seawave@2323','Seawave Forwarding Logistics','Delhi','27GDMPM3914G1Z4','Rishi','98657451222',NULL,NULL,NULL,'sdfdfsf vsdds',NULL,'Delhi-2323',0,NULL,NULL,NULL,NULL,NULL),(9,'seawave@2323','Seawave Forwarding Logistics','Kolkata','27GDMPM3914G1Z4','Aayush','98657451222',NULL,NULL,NULL,'Kolkata branch demo addresss',NULL,'Kolkata-2323',0,'admin',NULL,NULL,NULL,NULL),(10,'seatech@23','seatech','Mumbai','27AAICS7836D1Z4','kea','345345634',NULL,NULL,NULL,'dssd dad',NULL,'Mumbai-23',0,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `setworkflow` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table consists of all the detailed data of the particular workflow as per line of business';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transactionhistory` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=119 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='it will store all transaction dr and cr related to that job number ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is just for testing of DB connection and to verify that DB has been integrated';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'admin','12345678','c@2102','C Connect Logi',NULL,45),(2,'admin','12345','seatech@23','seatech',NULL,45),(3,'admin','12345','seawave@2323','Seawave Forwarding Logistics',NULL,6),(4,'test','1234','testorg@123','TestOrg',NULL,45),(5,'Test','Test1234','testorg@Test123','TestOrg',NULL,45);
...
CREATE TABLE `workflow` (
  ...
  `Date` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store the workflow rows ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `workflow` VALUES (1,'Air IMPORT','Mumbai','Seawave Forwarding Logistics','seawave@2323','ALL','admin','admin',0,NULL,NULL,NULL),(4,'Air EXPORT','Mumbai','Seawave Forwarding Logistics','seawave@2323','ALL','admin','admin',0,NULL,NULL,NULL),(9,'Sea IMPORT','All','Seawave Forwarding Logistics','seawave@2323','ALL','admin','admin',0,NULL,NULL,NULL),(10,'','All','Seawave Forwarding Logistics','seawave@2323','ALL','admin','admin',0,NULL,NULL,'2025-05-06'),(11,'','All','Seawave Forwarding Logistics','seawave@2323','ALL','admin','admin',0,NULL,NULL,'2025-05-06'),(12,'Sea IMPORT','Jogbani','Seawave Forwarding Logistics','seawave@2323','2','admin','admin',0,NULL,NULL,'2025-05-06'),(13,'Sea IMPORT','Dharashiv','Seawave Forwarding Logistics','seawave@2323','2','admin','admin',0,NULL,NULL,'2025-05-06'),(14,'Sea IMPORT','Dharashiv','Seawave Forwarding Logistics','seawave@2323','31','admin','admin',0,NULL,NULL,'2025-05-06'),(15,'Sea IMPORT','Dharashiv','Seawave Forwarding Logistics','seawave@2323','31','admin','admin',0,NULL,NULL,'2025-05-06'),(16,'test IMPORT','Jogbani','Seawave Forwarding Logistics','seawave@2323','ALL','admin','admin',0,NULL,NULL,'2025-05-06'),(17,'test IMPORT','Jogbani','Seawave Forwarding Logistics','seawave@2323','ALL','admin','admin',0,NULL,NULL,'2025-05-06'),(18,'Sea IMPORT','Jogbani','Seawave Forwarding Logistics','seawave@2323','ALL','admin','admin',0,NULL,NULL,'2025-05-06'),(19,'Sea IMPORT','Jogbani','Seawave Forwarding Logistics','seawave@2323','ALL','admin','admin',0,NULL,NULL,'2025-05-06'),(20,'Sea IMPORT','Jogbani','Seawave Forwarding Logistics','seawave@2323','ALL','admin','admin',0,NULL,NULL,'2025-05-06'),(21,'test IMPORT','Mumbai','Seawave Forwarding Logistics','seawave@2323','aryan pvt ltd','admin','admin',1,'test','2025-06-06 00:00:00','2025-05-06'),(22,'test IMPORT','Mumbai','Seawave Forwarding Logistics','seawave@2323','aryan pvt ltd',NULL,'admin',0,NULL,NULL,'2025-06-06');
...
-- Dump completed on 2025-07-04 16:49:29
