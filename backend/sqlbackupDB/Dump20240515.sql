...
INSERT INTO `approvalorg` VALUES ('seaconnect','India','Maharashtra','Navi Mumbai','400703','09004263507','shreypingle23@gmail.com','34','32534','342','34','Omkar Apartment  B-10-15 Sector-15 1:1','seawave@2323','Seawave Forwarding Logistics','seaconnect','Null','rishi@manager',1,'OrgButton','[{\"status\": \"Approve\", \"username\": \"rishi@manager\"}, {\"status\": \"Approve\", \"username\": \"aayush@manager\"}]'),('accenture','India','Maharashtra','Navi Mumbai','400703','09004263507','shreyashpingle752@gmail.com','34','89','342','34','Omkar Apartment B-10-15 Sector-15 1:1','seawave@2323','Seawave Forwarding Logistics','accenture services','vashi','rishi@manager',2,'OrgButton','[{\"status\": \"Approve\", \"username\": \"rishi@manager\"}, {\"status\": \"Approve\", \"username\": \"aayush@manager\"}]'),('apexsea','fgdfh','hfgjh','jgkj','776667','8764533423','fhfd@gmail.com','r445','gdg453','dfh435','3','fdsg','seawave@2323','Seawave Forwarding Logistics','Apexsea Logistics Pvt Ltd','Uganda','aayush@manager',3,'OrgButton','[{\"status\": \"Approve\", \"username\": \"rishi@manager\"}, {\"status\": \"Approve\", \"username\": \"aayush@manager\"}]');
...
INSERT INTO `approvername` VALUES (8,'Seawave Forwarding Logistics','seawave@2323','Organizations','rishi@manager','Raxaul','Raxaul-2323','[\"OrgButton\"]',4),(9,'Seawave Forwarding Logistics','seawave@2323','Jobs','aayush@manager','Raxaul','Raxaul-2323','[\"JobsButton\"]',5),(10,'Seawave Forwarding Logistics','seawave@2323','Organizations','hemang@executive','Raxaul','Raxaul-2323','[\"OrgButton\"]',4),(11,'Seawave Forwarding Logistics','seawave@2323','Organizations','aayush@manager','Raxaul','Raxaul-2323','[\"OrgButton\"]',4);
...
CREATE TABLE `branchaccess` (
  ...
  `orgcode` varchar(150) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is for access of users for their org branches ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `branchaccess` VALUES (1,'Raxaul','Raxaul-2323','rishi@manager','Seawave Forwarding Logistics','seawave@2323'),(3,'Jogbani','Jogbani-2323','hemang@executive','Seawave Forwarding Logistics','seawave@2323'),(4,'Raxaul','Raxaul-2323','hemang@executive','Seawave Forwarding Logistics','seawave@2323'),(5,'Raxaul','Raxaul-2323','aayush@manager','Seawave Forwarding Logistics','seawave@2323'),(7,'Jogbani','Jogbani-2323','shreyash@executive','Seawave Forwarding Logistics','seawave@2323'),(8,'Jogbani','Jogbani-2323','aayush@manager','Seawave Forwarding Logistics','seawave@2323');
...
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is the branches table that are linked to organizations';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `contacts` VALUES ('Shreyash Pingle','IT','IT','8655997288','omaayush@mail.com','Ahemdabad','Seawave Forwarding Logistics','seawave@2323','Seatech',4);
...
INSERT INTO `notifications` VALUES ('Seawave Forwarding Logistics','seawave@2323','Omkar Apartment  B-10-15 Sector-15 1:1','seaconnect','India','Maharashtra','Navi Mumbai','seaconnect','400703','09004263507','shreypingle23@gmail.com','34','32534','342','Null','34','rishi@manager',1,'OrgButton','[{\"read\": 1, \"approved\": 1, \"employeename\": \"rishi@manager\"}, {\"read\": 0, \"approved\": 0, \"employeename\": \"hemang@executive\"}, {\"read\": 1, \"approved\": 1, \"employeename\": \"aayush@manager\"}]','[{\"time\": null, \"employeename\": \"rishi@manager\"}, {\"time\": null, \"employeename\": \"hemang@executive\"}, {\"time\": null, \"employeename\": \"aayush@manager\"}]','[{\"employeename\": \"rishi@manager\"}, {\"employeename\": \"hemang@executive\"}, {\"employeename\": \"aayush@manager\"}]',0),('Seawave Forwarding Logistics','seawave@2323','Omkar Apartment B-10-15 Sector-15 1:1','accenture services','India','Maharashtra','Navi Mumbai','accenture','400703','09004263507','shreyashpingle752@gmail.com','34','89','342','vashi','34','rishi@manager',2,'OrgButton','[{\"read\": 1, \"approved\": 1, \"employeename\": \"rishi@manager\"}, {\"read\": 0, \"approved\": 0, \"employeename\": \"hemang@executive\"}, {\"read\": 1, \"approved\": 1, \"employeename\": \"aayush@manager\"}]','[{\"time\": null, \"employeename\": \"rishi@manager\"}, {\"time\": null, \"employeename\": \"hemang@executive\"}, {\"time\": null, \"employeename\": \"aayush@manager\"}]','[{\"employeename\": \"rishi@manager\"}, {\"employeename\": \"hemang@executive\"}, {\"employeename\": \"aayush@manager\"}]',2),('Seawave Forwarding Logistics','seawave@2323','fdsg','Apexsea Logistics Pvt Ltd','fgdfh','hfgjh','jgkj','apexsea','776667','8764533423','fhfd@gmail.com','r445','gdg453','dfh435','Uganda','3','aayush@manager',3,'OrgButton','[{\"read\": 1, \"approved\": 1, \"employeename\": \"rishi@manager\"}, {\"read\": 0, \"approved\": 0, \"employeename\": \"hemang@executive\"}, {\"read\": 1, \"approved\": 1, \"employeename\": \"aayush@manager\"}]','[{\"time\": null, \"employeename\": \"rishi@manager\"}, {\"time\": null, \"employeename\": \"hemang@executive\"}, {\"time\": null, \"employeename\": \"aayush@manager\"}]','[{\"employeename\": \"rishi@manager\"}, {\"employeename\": \"hemang@executive\"}, {\"employeename\": \"aayush@manager\"}]',3);
...
INSERT INTO `organizations` VALUES ('seaconnect','India','Maharashtra','Navi Mumbai','400703','09004263507','shreypingle23@gmail.com','34','32534','342','34','Omkar Apartment  B-10-15 Sector-15 1:1','seawave@2323','Seawave Forwarding Logistics','seaconnect',1,'Null','rishi@manager','OrgButton'),('accenture','India','Maharashtra','Navi Mumbai','400703','09004263507','shreyashpingle752@gmail.com','34','89','342','34','Omkar Apartment B-10-15 Sector-15 1:1','seawave@2323','Seawave Forwarding Logistics','accenture services',2,'vashi','rishi@manager','OrgButton'),('apexsea','fgdfh','hfgjh','jgkj','776667','8764533423','fhfd@gmail.com','r445','gdg453','dfh435','3','fdsg','seawave@2323','Seawave Forwarding Logistics','Apexsea Logistics Pvt Ltd',3,'Uganda','aayush@manager','OrgButton');
...
CREATE TABLE `ownbranches` (
  ...
  `branchcode` varchar(150) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table consists of the data of the branches of the organization.\n    ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ownbranches` VALUES (1,'seawave@2323','Seawave Forwarding Logistics','Raxaul','325345dfgdfh','768ghgh','Ffff','7654334323','EUUUUUUUUUUUUUUUU','Raxaul-2323'),(3,'seawave@2323','Seawave Forwarding Logistics','Kolkata Bihar','09AAIC7836D1Z9','4549666','Sanoj','5896663866','WB','Kolkata-2323'),(4,'seawave@2323','Seawave Forwarding Logistics','Jogbani','sfdsf453453','435fg','hrdeptu','2352523323','Omkar Apartment B-10-15 Sector-15 1:1','Jogbani-2323');
...
-- Dump completed on 2024-05-15 14:48:34
