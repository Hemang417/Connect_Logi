...
CREATE TABLE `collection` (
  `id` int NOT NULL AUTO_INCREMENT,
  `jobnumber` varchar(45) COLLATE utf8mb4_0900_as_ci NOT NULL,
  ...
  `Date` date NOT NULL,
  `billNo` varchar(45) COLLATE utf8mb4_0900_as_ci NOT NULL,
  `amount` varchar(45) COLLATE utf8mb4_0900_as_ci NOT NULL,
  `Tax` varchar(45) COLLATE utf8mb4_0900_as_ci NOT NULL,
  `grandTotal` varchar(45) COLLATE utf8mb4_0900_as_ci NOT NULL,
  `FollowUp1` date DEFAULT NULL,
  `FollowUp2` date DEFAULT NULL,
  `FollowUp3` date DEFAULT NULL,
  `TimeDelay` varchar(45) COLLATE utf8mb4_0900_as_ci DEFAULT NULL,
  `AssignTo` varchar(45) COLLATE utf8mb4_0900_as_ci DEFAULT NULL,
...
CREATE TABLE `credit` (
  ...
  `postDate` varchar(45) COLLATE utf8mb4_0900_as_ci NOT NULL,
  `bankAccount` varchar(45) COLLATE utf8mb4_0900_as_ci NOT NULL,
  `organizationType` varchar(45) COLLATE utf8mb4_0900_as_ci NOT NULL,
  `organizationName` varchar(45) COLLATE utf8mb4_0900_as_ci NOT NULL,
  `receivedPayementType` varchar(45) COLLATE utf8mb4_0900_as_ci NOT NULL,
  `amountReceived` varchar(45) COLLATE utf8mb4_0900_as_ci NOT NULL,
  `remarks` varchar(45) COLLATE utf8mb4_0900_as_ci NOT NULL,
  `orgname` varchar(45) COLLATE utf8mb4_0900_as_ci NOT NULL,
  `orgcode` varchar(45) COLLATE utf8mb4_0900_as_ci NOT NULL,
  `branchname` varchar(45) COLLATE utf8mb4_0900_as_ci NOT NULL,
  `branchcode` varchar(45) COLLATE utf8mb4_0900_as_ci NOT NULL,
  `billNoForAgainstBill` json DEFAULT NULL,
  `billamountForAgainstBill` json DEFAULT NULL,
  `tdsDeductionForAgainstBill` json DEFAULT NULL,
  `totalReceivableForAgainstBill` json DEFAULT NULL,
  `totalForAgainstBill` varchar(45) COLLATE utf8mb4_0900_as_ci DEFAULT NULL,
  `onAcType` varchar(45) COLLATE utf8mb4_0900_as_ci DEFAULT NULL,
  `jobNoForAgainstJob` json DEFAULT NULL,
  `amountForAgainstJob` json DEFAULT NULL,
  `totalForAgainstJob` varchar(45) COLLATE utf8mb4_0900_as_ci DEFAULT NULL,
  `AgainstOutstandingPayment Advise` varchar(45) COLLATE utf8mb4_0900_as_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `impgeneral` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_job_number` (`jobnumber`)
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is to store the general component data ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `impjobcreation` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_jobnumber` (`jobnumber`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is where all creation of job in import will be stored';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-11-25 16:53:15
