...
INSERT INTO `approvalimpjob` VALUES (1,'Jogbani/A/24-25/I/yy/1','2024-09-11 11:38:00','2024-09-09 11:38:00','Air','Mumbai Sea','Yes','Loaded',23,'Yes','Home','FCL','dummy6','dummy6','HBL/HAWB','dummy6','Seawave Forwarding Logistics','seawave@2323','hemang@executive','2','Original','23','Yearly','1','Jogbani','Jogbani-2323','Gondya','dfs','27GDMPM3914G1Z4','GDMPM3914G','pune','qwsa','[{\"status\": \"Approve\", \"employeename\": \"hemang@executive\"}, {\"status\": \"Approve\", \"employeename\": \"aayush@manager\"}]','JobsButton','2024-09-11 11:38:45','gond'),(2,'Jogbani/A/24-25/I/yy/2','2024-09-11 11:41:00','2024-09-10 11:40:00','Air','Mumbai Sea','Yes','Loaded',2,'Yes','In-Bond','LCL','dummy67','dummy67','HBL/HAWB','fgdgfdg','Seawave Forwarding Logistics','seawave@2323','aayush@manager','2','Surrender','3453453','Yearly','2','Jogbani','Jogbani-2323','Gondya','dfs','27GDMPM3914G1Z4','GDMPM3914G','mumbai','qwsa','[{\"status\": \"Approve\", \"employeename\": \"hemang@executive\"}, {\"status\": \"Approve\", \"employeename\": \"aayush@manager\"}]','JobsButton','2024-09-11 11:41:02','gond'),(3,'Jogbani/A/24-25/I/yy/3','2024-09-11 11:45:00','2024-09-09 11:45:00','Air','Jogbani LCS','Yes','Loaded',3,'Yes','Ex-Bond','Break Bulk','dummy50','dummy50','HBL/HAWB','dummy50','Seawave Forwarding Logistics','seawave@2323','hemang@executive','2','Surrender','453453','Yearly','3','Jogbani','Jogbani-2323','Allcargo Pvt Ltd','1/35454','27AAICS7836D1Z4','AAICS7836D','delhi','qwsa','[{\"status\": \"Approve\", \"employeename\": \"hemang@executive\"}, {\"status\": \"Approve\", \"employeename\": \"aayush@manager\"}]','JobsButton','2024-09-11 11:45:48','Mumbai'),(4,'Jogbani/A/24-25/I/yy/4','2024-09-12 12:45:00','2024-09-11 12:45:00','Air','Kolkata Sea','Yes','Loaded',2,'Yes','Home','FCL','gdfgcgd','sdbdhh','MBL/MAWB','gdgderg','Seawave Forwarding Logistics','seawave@2323','hemang@executive','1','Surrender','23','Yearly','4','Jogbani','Jogbani-2323','Allcargo Pvt Ltd','1/35454','27AAICS7836D1Z4','AAICS7836D','kttttt','fgdg','[{\"status\": \"Approve\", \"employeename\": \"hemang@executive\"}, {\"status\": \"Approve\", \"employeename\": \"aayush@manager\"}]','JobsButton','2024-09-12 12:45:58','Mumbai'),(5,'Jogbani/S/24-25/I/yy/5','2024-09-12 15:22:00','2024-09-11 15:22:00','Sea','Mumbai Sea','Yes','Loaded',2,'Yes','In-Bond','FCL','fsfsdf','sfsfsf','HBL/HAWB','gdggd','Seawave Forwarding Logistics','seawave@2323','admin','2','Surrender','23','Yearly','5','Jogbani','Jogbani-2323','Allcargo Pvt Ltd','1/35454','27AAICS7836D1Z4','AAICS7836D','sfsff','fsfs','[{\"status\": \"Approve\", \"employeename\": \"hemang@executive\"}, {\"status\": \"Approve\", \"employeename\": \"aayush@manager\"}]','JobsButton','2024-09-12 15:22:49','Mumbai'),(6,'Jogbani/A/24-25/I/yy/6','2024-09-12 16:37:00','2024-09-10 16:36:00','Air','Mumbai Sea','Yes','Loaded',2,'Yes','In-Bond','LCL','dfsfdfs','fsfsfsf','MBL/MAWB','dgdgdg','Seawave Forwarding Logistics','seawave@2323','hemang@executive','3','Surrender','2432','Yearly','6','Jogbani','Jogbani-2323','Gondya','dfs','27GDMPM3914G1Z4','GDMPM3914G','sfsfdfs','sff','[{\"status\": \"Approve\", \"employeename\": \"hemang@executive\"}, {\"status\": null, \"employeename\": \"aayush@manager\"}]','JobsButton','2024-09-12 16:37:21','gond');
...
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is to store the general component data ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `expnotifications` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store export notifications ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `impgeneral` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_job_number` (`jobnumber`)
) ENGINE=InnoDB AUTO_INCREMENT=73 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is to store the general component data ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `impnotifications` (
  ...
  `username` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store import notifications ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reminders` VALUES ('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}]','E-SANCHIT',4,'2024-09-10T07:15:00.000Z','Air IMPORT','Jogbani','1','00','00','Pending',5,'Jogbani/A/24-25/I/yy/4');
...
INSERT INTO `trackingexport` VALUES (3,'ETA','2024-09-28T05:15:00.000Z','2024-09-13T10:45','-360 hr 0 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','Jogbani/A/24-25/E/yy/3','hemang@executive','d hr min','Air EXPORT','Jogbani','Jogbani-2323','Gondya'),(4,'E-SANCHIT','2024-09-30T05:15:00.000Z','2024-09-13T10:46','-408 hr -59 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','Jogbani/A/24-25/E/yy/3','hemang@executive','2d 00hr 00min','Air EXPORT','Jogbani','Jogbani-2323','Gondya');
...
INSERT INTO `trackingimport` VALUES (3,'ETA','2024-09-27T06:26:00.000Z','2024-09-13T13:13','-335 hr -43 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','Jogbani/A/24-25/I/yy/4','admin','d hr min','Air IMPORT','Jogbani','Jogbani-2323','Allcargo Pvt Ltd'),(4,'PORT CFS NOMINATION','2024-09-25T06:26:00.000Z','2024-09-13T13:14','-287 hr -42 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','Jogbani/A/24-25/I/yy/4','admin','2d 00hr 00min','Air IMPORT','Jogbani','Jogbani-2323','Allcargo Pvt Ltd');
...
-- Dump completed on 2024-09-13 14:42:34
