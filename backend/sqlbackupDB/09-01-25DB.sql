...
CREATE TABLE `approvalimpjob` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store approvaljob before actually approving or rejecting';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=188 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is the branches table that are linked to organizations';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `collection` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_as_ci COMMENT='collection table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `collection` VALUES (5,'A/Mumbai/E/24-25/3','Seawave Forwarding Logistics','seawave@2323','mumbai','Mumbai-2323','Mumbai','Allcargo Pvt Ltd','2024-12-21','45649862565','58','78','136.00','2025-02-26','2025-03-05','2025-03-12','','Hemang Ranjan',0,1,'2025-01-09 14:26:32'),(6,'A/Mumbai/I/24-25/1','Seawave Forwarding Logistics','seawave@2323','Andheri','Mumbai-2323','Mumbai','vedant  ltd pvt','2024-12-21','4563455234','4535','4534','9069.00','2025-02-04','2025-02-11','2025-02-18','','Hemang Ranjan',0,0,NULL),(7,'A/Mumbai/E/24-25/6','Seawave Forwarding Logistics','seawave@2323','Bihar','Mumbai-2323','Mumbai','vedant  ltd pvt','2024-12-26','52354222','58','3424','3482.00','2025-02-09','2025-02-16','2025-02-23','','Hemang Ranjan',0,0,NULL),(8,'A/Mumbai/E/24-25/6','Seawave Forwarding Logistics','seawave@2323','Bihar','Mumbai-2323','Mumbai','vedant  ltd pvt','2024-12-26','32342342','4242434','7844','4250278.00','2025-02-09','2025-02-16','2025-02-23','','Rishi Mishra',0,0,NULL),(9,'A/Mumbai/E/24-25/6','Seawave Forwarding Logistics','seawave@2323','Bihar','Mumbai-2323','Mumbai','vedant  ltd pvt','2024-12-31','5353533','10000.78','23234','33234.78','2025-02-14','2025-02-21','2025-02-28','','Hemang Ranjan',0,0,NULL),(10,'A/Mumbai/I/24-25/15','Seawave Forwarding Logistics','seawave@2323','Andheri','Mumbai-2323','Mumbai','Allcargo Pvt Ltd','2025-01-07','534534535','1000.56','34','1034.56','2025-02-10','2025-02-17','2025-02-24','','Hemang Ranjan',0,0,NULL);
...
CREATE TABLE `impjobcreation` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_jobnumber` (`jobnumber`)
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is where all creation of job in import will be stored';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `impnotifications` (
  ...
  `username` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store import notifications ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store client data and employee that created the client ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reminders` (
  ...
  `jobnumber` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=77 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store reminders for import';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transactionhistory` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='it will store all transaction dr and cr related to that job number ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES ('admin','12345678','c@2102','C Connect Logi',45),('admin','12345','seatech@23','seatech',45),('admin','12345','seawave@2323','Seawave Forwarding Logistics',1),('test','1234','testorg@123','TestOrg',45),('Test','Test1234','testorg@Test123','TestOrg',45);
...
-- Dump completed on 2025-01-09 18:02:19
