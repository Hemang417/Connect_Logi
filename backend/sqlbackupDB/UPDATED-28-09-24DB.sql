...
CREATE TABLE `approvalimpjob` (
  ...
  `remark` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store approvaljob before actually approving or rejecting';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is to store the general component data ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is where all creation of job in export will be stored';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `impgeneral` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_job_number` (`jobnumber`)
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is to store the general component data ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `impjobcreation` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_jobnumber` (`jobnumber`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is where all creation of job in import will be stored';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `impnotifications` (
  ...
  `username` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store import notifications ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `milestone` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table contains all the milestones';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `setworkflow` VALUES (1,'Air IMPORT','Jogbani','null','Seawave Forwarding Logistics','seawave@2323','','','','','',1,'ETA','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','2','00','00','2024-09-11 06:06:58'),(2,'Air IMPORT','Jogbani','null','Seawave Forwarding Logistics','seawave@2323','ETA','Before','2','00','00',0,'PORT CFS NOMINATION','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','2','00','00','2024-09-11 06:13:13'),(3,'Air EXPORT','Jogbani','null','Seawave Forwarding Logistics','seawave@2323','','','','','',1,'ETA','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','2','00','00','2024-09-11 07:13:35'),(4,'Air EXPORT','Jogbani','null','Seawave Forwarding Logistics','seawave@2323','ETA','After','2','00','00',0,'E-SANCHIT','[{\"username\": \"hemang@executive\"}]','1','00','00','2024-09-11 07:31:31'),(5,'Air IMPORT','Jogbani','null','Seawave Forwarding Logistics','seawave@2323','Job Creation Date','Before','2','00','00',0,'E-SANCHIT','[{\"username\": \"hemang@executive\"}]','1','00','00','2024-09-12 07:14:18'),(6,'Sea IMPORT','Jogbani','null','Seawave Forwarding Logistics','seawave@2323','','','','','',1,'ETA','[{\"username\": \"hemang@executive\"}]','3','00','00','2024-09-12 09:39:13'),(7,'Sea IMPORT','Jogbani','null','Seawave Forwarding Logistics','seawave@2323','ETA','After','2','00','00',0,'processing','[{\"username\": \"hemang@executive\"}]','4','00','00','2024-09-12 09:52:11'),(8,'Air IMPORT','Mumbai','null','Seawave Forwarding Logistics','seawave@2323','','','','','',1,'ETA','[{\"username\": \"hemang@executive\"}, {\"username\": \"aayush@manager\"}]','2','00','00','2024-09-28 06:08:47');
...
CREATE TABLE `workflow` (
  ...
  `importername` varchar(150) DEFAULT 'null',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store the workflow rows ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-09-28 16:47:24
