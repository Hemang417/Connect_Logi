...
CREATE TABLE `reminders` (
  ...
  `jobnumber` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store reminders for import';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reminders` VALUES ('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"rishi@manager\"}, {\"username\": \"aayush@manager\"}]','ETA',1,'2024-11-29T15:04','Air IMPORT','ALL','2','00','00','Pending',4,'Jogbani/A/24-25/6/I'),('Seawave Forwarding Logistics','seawave@2323','[{\"username\": \"hemang@executive\"}, {\"username\": \"rishi@manager\"}, {\"username\": \"aayush@manager\"}]','ETA',2,'2024-11-28T15:03','Air IMPORT','ALL','2','00','00','Pending',4,'A/Mumbai/I/24-25/9');
...
INSERT INTO `trackingimport` VALUES (1,'ETA','2024-11-28T15:03',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/9','aayush@manager',' d  hr  min','Air Import','Mumbai','Mumbai-2323','C CONNECT LOGGI'),(2,'ETA','2024-11-29T15:04',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','Jogbani/A/24-25/6/I','aayush@manager',' d  hr  min','Air Import','Jogbani','Jogbani-2323','C CONNECT LOGGI'),(3,'ETA','2024-11-09T13:55',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/14','aayush@manager',' d  hr  min','Air Import','Mumbai','Mumbai-2323','Allcargo Pvt Ltd'),(4,'PORT CFS NOMINATION','2024-11-07T12:55',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/14','aayush@manager','2 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Allcargo Pvt Ltd');
...
-- Dump completed on 2024-11-05 16:10:42
