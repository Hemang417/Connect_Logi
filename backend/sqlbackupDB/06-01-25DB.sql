...
INSERT INTO `approvalexpjob` VALUES (1,'A/Mumbai/E/24-25/1','2025-01-06 16:17:00','2025-01-05 16:16:00','Air','Mumbai Sea','No','Dock Stuff',2,'No','Home','LCL','dummy45','shfjfhs','1','Mumbai','Mumbai-2323','mumbai','adani pvt ltd','dasdas asdadfadf','27AAICS7836D1Z3','AAICS7836D','jsks','mumbai','[]','','',NULL,NULL,'[{\"type\": \"40\'\", \"weight\": \"34\", \"container\": 1, \"containerNo\": \"24242\"}, {\"type\": \"20\'\", \"weight\": \"43\", \"container\": 2, \"containerNo\": \"23423\"}]','ExpJobButton','2025-01-06 16:17:45','HBL/HAWB','fetch Persons','40\', 20\'','53455','admin','seawave@2323','Seawave Forwarding Logistics','5545',1,'admin','1','2025-01-06 17:19:16'),(2,'A/Mumbai/E/24-25/2','2025-01-06 16:19:00','2025-01-05 16:19:00','Air','Mumbai Sea','No','Dock Stuff',1,'No','In-Bond','FCL','dummy45','dumpy45','2','Mumbai','Mumbai-2323','mumbai','adani pvt ltd','dasdas asdadfadf','27AAICS7836D1Z3','AAICS7836D','sdasd','mumbai','[]','','',NULL,NULL,'[{\"type\": \"40\'\", \"weight\": \"3\", \"container\": 1, \"containerNo\": \"12122\"}]','ExpJobButton','2025-01-06 16:19:34','MBL/MAWB','fetch Persons','40\'','123323','admin','seawave@2323','Seawave Forwarding Logistics','5545',0,NULL,NULL,NULL),(3,'A/Mumbai/E/24-25/3','2025-01-06 16:22:00','2025-01-05 16:22:00','Air','Kolkata Sea','Yes','Dock Stuff',2,'No','In-Bond','FCL','dummy45','dumpy45','3','Mumbai','Mumbai-2323','Andheri','Allcargo Pvt Ltd','dsdafsfs fsfsdfsf','27AAICS7836D1Z3','AAICS7836D','JOGBANI LCS','NHAVA SHEVA','[]','','',NULL,NULL,'[{\"type\": \"40\'\", \"weight\": \"34\", \"container\": 1, \"containerNo\": \"4234234\"}, {\"type\": \"20\' ISO Tank\", \"weight\": \"34\", \"container\": 2, \"containerNo\": \"4234344\"}]','ExpJobButton','2025-01-06 16:23:06','HBL/HAWB','fetch Persons','40\', 20\' ISO Tank','53455','admin','seawave@2323','Seawave Forwarding Logistics','5545',0,NULL,NULL,NULL),(4,'A/Mumbai/E/24-25/4','2025-01-06 16:27:00','2025-01-05 16:27:00','Air','Mumbai Sea','No','Dock Stuff',2,'No','In-Bond','FCL','dummy45','shfjfhs','4','Mumbai','Mumbai-2323','mumbai','adani pvt ltd','dasdas asdadfadf','27AAICS7836D1Z3','AAICS7836D','dfgdg','mumbai','[]','','',NULL,NULL,'[{\"type\": \"20\'\", \"weight\": \"23\", \"container\": 1, \"containerNo\": \"213123\"}, {\"type\": \"20\'\", \"weight\": \"21\", \"container\": 2, \"containerNo\": \"31231\"}]','ExpJobButton','2025-01-06 16:28:00','HBL/HAWB','fetch Persons','20\'','34232','admin','seawave@2323','Seawave Forwarding Logistics','5545',0,NULL,NULL,NULL),(5,'A/Mumbai/E/24-25/5','2025-01-06 16:34:00','2025-01-05 16:33:00','Air','Valvada ICD','No','Factory Stuff',1,'No','In-Bond','LCL','dummy45','shfjfhs','5','Mumbai','Mumbai-2323','vapi','vedant  ltd pvt','sdffafas dafafafa','27AAICS7836D1Z3','AAICS7836D','jsks','mumbai','[]','','',NULL,NULL,'[{\"type\": \"20\'\", \"weight\": \"3\", \"container\": 1, \"containerNo\": \"34243\"}]','ExpJobButton','2025-01-06 16:34:04','HBL/HAWB','fetch Persons','20\'','53455','admin','seawave@2323','Seawave Forwarding Logistics','5545',0,NULL,NULL,NULL),(6,'A/Mumbai/E/24-25/6','2025-01-06 17:05:00','2025-01-07 17:05:00','Air','Mumbai Sea','No','Dock Stuff',1,'No','In-Bond','FCL','dummy45','dumpy45','6','Mumbai','Mumbai-2323','Andheri','Allcargo Pvt Ltd','dsdafsfs fsfsdfsf','27AAICS7836D1Z3','AAICS7836D','JOGBANI LCS','NHAVA SHEVA','[]','','',NULL,NULL,'[{\"type\": \"20\'\", \"weight\": \"44\", \"container\": 1, \"containerNo\": \"552342\"}]','ExpJobButton','2025-01-06 17:06:11','HBL/HAWB','fetch Persons','20\', 40\'','53455','admin','seawave@2323','Seawave Forwarding Logistics','5545',0,NULL,NULL,NULL);
...
CREATE TABLE `approvalimpjob` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store approvaljob before actually approving or rejecting';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `approvalorg` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store the organizations before approval';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=187 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is the branches table that are linked to organizations';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `impnotifications` (
  ...
  `username` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store import notifications ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notifications` (
  ...
  `createdat` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store notifications and its data';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-01-06 17:28:49
