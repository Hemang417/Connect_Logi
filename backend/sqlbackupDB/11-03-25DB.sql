...
CREATE TABLE `approvalimpjob` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store approvaljob before actually approving or rejecting';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `approverlist` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store the name of the approver list of a particular organization';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `approverlist` VALUES ('Seawave Forwarding Logistics','seawave@2323',3,'Import Job Creation','Mumbai','Mumbai-2323','[\"ImpJobButton\"]',1),('Seawave Forwarding Logistics','seawave@2323',5,'Import Job Creation','Jogbani','Jogbani-2323','[\"ImpJobButton\"]',1),('Seawave Forwarding Logistics','seawave@2323',8,'Export Job Creation','Mumbai','Mumbai-2323','[\"ExpJobButton\"]',1),('Seawave Forwarding Logistics','seawave@2323',9,'Organization Creation','Mumbai','Mumbai-2323','[\"OrgButton\"]',1);
...
CREATE TABLE `approvername` (
  ...
  `aid` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store all the names of users for a particular approval list';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `approvername` VALUES (26,'Seawave Forwarding Logistics','seawave@2323','Import Job Creation','hemang@executive','Mumbai','Mumbai-2323','[\"ImpJobButton\"]',3),(29,'Seawave Forwarding Logistics','seawave@2323','Export Job Creation','hemang@executive','Mumbai','Mumbai-2323','[\"ExpJobButton\"]',8),(30,'Seawave Forwarding Logistics','seawave@2323','Import Job Creation','hemang@executive','Jogbani','Jogbani-2323','[\"ImpJobButton\"]',5),(35,'Seawave Forwarding Logistics','seawave@2323','Organization Creation','hemang@executive','Mumbai','Mumbai-2323','[\"OrgButton\"]',9);
...
CREATE TABLE `collection` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_as_ci COMMENT='collection table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `impjobcreation` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_jobnumber` (`jobnumber`)
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is where all creation of job in import will be stored';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `impnotifications` (
  ...
  `username` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store import notifications ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lob` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='line of business table as per users prefrences';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reminders` (
  ...
  `jobnumber` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=121 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store reminders for import';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `trackingexport` VALUES (1,'ETA','2025-02-19T12:48:00.000Z','2025-03-13T18:30','528 hr 12 min','saasaas','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/E/24-25/4','admin','d hr min','Air EXPORT','Mumbai','Mumbai-2323','adani pvt ltd',0,NULL),(2,'ETA','2024-12-28T11:41','2025-02-19T12:35','1272 hr 54 min','sanjeet','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/E/24-25/5','admin','d hr min','Air EXPORT','Mumbai','Mumbai-2323','vedant  ltd pvt',0,NULL),(3,'ETA','2025-01-23T16:44',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/E/24-25/2','admin',' d  hr  min','Air EXPORT','Mumbai','Mumbai-2323','Allcargo Pvt Ltd',0,NULL),(4,'ETA','2025-02-14T12:06:00.000Z','2025-02-20T17:37','144 hr 1 min','terer','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/E/24-25/6','admin','d hr min','Air EXPORT','Mumbai','Mumbai-2323','Allcargo Pvt Ltd',0,NULL),(5,'ETA','2025-03-15T13:01:00.000Z','2025-03-13T18:31','-48 hr 0 min','assa','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/E/24-25/16','admin','d hr min','Air EXPORT','Mumbai','Mumbai-2323','Allcargo Pvt Ltd',0,NULL);
...
INSERT INTO `trackingimport` VALUES (1,'ETA','2024-11-23T16:35',NULL,NULL,'rrerer','Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/22','aayush@manager',' d  hr  min','Air Import','Mumbai','Mumbai-2323','C CONNECT LOGGI',0,NULL),(2,'processing','2024-11-15T16:35',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/22','aayush@manager','07 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','C CONNECT LOGGI',0,NULL),(3,'E-SANCHIT','2024-11-26T04:35',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/22','aayush@manager','02 d 12 hr 00 min','Air Import','Mumbai','Mumbai-2323','C CONNECT LOGGI',0,NULL),(4,'Packaging','2024-11-18T15:40',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/22','aayush@manager','03 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','C CONNECT LOGGI',0,NULL),(5,'PORT CFS NOMINATION','2024-11-15T16:35',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/22','aayush@manager','03 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','C CONNECT LOGGI',0,NULL),(6,'Scanning ','2024-12-31T03:11',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/1','admin','05 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Highland Residency',0,NULL),(7,'ETA','2024-12-13T15:11',NULL,NULL,'rrerer','Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/1','admin',' d  hr  min','Air Import','Mumbai','Mumbai-2323','Highland Residency',0,NULL),(8,'processing','2024-12-26T03:11',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/1','admin','07 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Highland Residency',0,NULL),(9,'PORT CFS NOMINATION','2024-12-19T03:11',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/1','admin','03 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Highland Residency',0,NULL),(10,'E-SANCHIT','2024-12-16T03:11',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/1','admin','02 d 12 hr 00 min','Air Import','Mumbai','Mumbai-2323','Highland Residency',0,NULL),(11,'Packaging','2024-12-08T17:19',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/1','admin','03 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Highland Residency',0,NULL),(12,'ETA','2024-12-23T11:02:00.000Z','2024-12-24T16:36','24 hr 4 min','rrerer','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/8','admin','d hr min','Air IMPORT','Mumbai','Mumbai-2323','Tray ltd pvt',0,NULL),(13,'processing','2025-01-05T04:32',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/8','admin','07 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Tray ltd pvt',0,NULL),(14,'Scanning ','2025-01-10T04:32',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/8','admin','05 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Tray ltd pvt',0,NULL),(15,'Packaging','2024-12-27T16:24',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/8','admin','03 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Tray ltd pvt',0,NULL),(16,'PORT CFS NOMINATION','2024-12-29T04:32',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/8','admin','03 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Tray ltd pvt',0,NULL),(17,'E-SANCHIT','2024-12-25T23:02:00.000Z','2024-12-24T16:36','-36 hr -56 min',NULL,'Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/8','admin','02d 12hr 00min','Air IMPORT','Mumbai','Mumbai-2323','Tray ltd pvt',0,NULL),(18,'ETA','2024-12-19T11:09:00.000Z','2024-12-24T16:39','120 hr 0 min','rrerer','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/7','admin','d hr min','Air IMPORT','Mumbai','Mumbai-2323','Tray ltd pvt',0,NULL),(19,'processing','2024-12-31T23:09:00.000Z',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/7','admin','07d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','Tray ltd pvt',0,NULL),(20,'Scanning ','2025-01-06T04:39',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/7','admin','05 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Tray ltd pvt',0,NULL),(21,'Packaging','2024-12-27T16:18',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/7','admin','03 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Tray ltd pvt',0,NULL),(22,'PORT CFS NOMINATION','2024-12-25T04:39',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/7','admin','03 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Tray ltd pvt',0,NULL),(23,'E-SANCHIT','2024-12-22T04:39',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/7','admin','02 d 12 hr 00 min','Air Import','Mumbai','Mumbai-2323','Tray ltd pvt',0,NULL),(24,'ETA','2024-12-20T12:21:00.000Z',NULL,NULL,'rrerer','Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/11','aayush@manager','d hr min','Air IMPORT','Mumbai','Mumbai-2323','adani pvt ltd',0,NULL),(25,'processing','2025-01-02T00:21:00.000Z',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/11','aayush@manager','07d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','adani pvt ltd',0,NULL),(26,'PORT CFS NOMINATION','2024-12-26T00:21:00.000Z',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/11','admin','03d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','adani pvt ltd',0,NULL),(27,'Scanning ','2025-01-07T00:21:00.000Z',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/11','aayush@manager','05d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','adani pvt ltd',0,NULL),(28,'E-SANCHIT','2024-12-23T00:21:00.000Z',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/11','admin','02d 12hr 00min','Air IMPORT','Mumbai','Mumbai-2323','adani pvt ltd',0,NULL),(29,'ETA','2024-12-19T14:43','2025-01-07T11:01','452 hr 18 min','rrerer','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/13','admin','d hr min','Air IMPORT','Mumbai','Mumbai-2323','adani pvt ltd',0,NULL),(30,'processing','2025-01-01T02:43',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/13','admin','07 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','adani pvt ltd',0,NULL),(31,'Scanning ','2025-01-06T02:43',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/13','admin','05 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','adani pvt ltd',0,NULL),(32,'E-SANCHIT','2024-12-22T02:43',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/13','admin','02 d 12 hr 00 min','Air Import','Mumbai','Mumbai-2323','adani pvt ltd',0,NULL),(33,'Packaging','2024-12-27T17:59',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/13','admin','03 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','adani pvt ltd',0,NULL),(34,'PORT CFS NOMINATION','2024-12-25T02:43',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/13','admin','03 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','adani pvt ltd',0,NULL),(63,'ETA','2025-02-02T12:28','2025-03-13T14:56','938 hr 28 min','sasa','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/19','admin','d hr min','Air IMPORT','Mumbai','Mumbai-2323','muggles',0,NULL),(64,'Packaging','2025-02-03T12:28:00.000Z','2025-03-13T14:56','908 hr 58 min','gdfggfbf','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/19','admin','03d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','muggles',0,NULL),(65,'Scanning ','2025-02-20T00:28','2025-03-13T14:56','518 hr 28 min','fdfrfs','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/19','admin','05d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','muggles',0,NULL),(66,'E-SANCHIT','2025-02-05T00:28','2025-03-13T14:56','878 hr 28 min','wdw','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/19','admin','02d 12hr 00min','Air IMPORT','Mumbai','Mumbai-2323','muggles',0,NULL),(67,'processing','2025-02-15T00:28','2025-03-13T14:56','638 hr 28 min','rwwadc','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/19','admin','07d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','muggles',0,NULL),(68,'PORT CFS NOMINATION','2025-02-08T00:28','2025-03-13T14:56','806 hr 28 min','dvdca','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/19','admin','03d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','muggles',0,NULL),(69,'Packaging','2025-02-25T09:51:00.000Z','2025-03-13T13:59','382 hr 38 min','xssxs','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/27','admin','03d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','sanjeet pvt ltd',0,NULL),(70,'ETA','2025-03-01T10:11:00.000Z','2025-03-06T15:41','120 hr 0 min','dsasa','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/27','admin','d hr min','Air IMPORT','Mumbai','Mumbai-2323','sanjeet pvt ltd',0,NULL),(71,'Scanning ','2025-03-18T22:11:00.000Z','2025-03-06T15:41','-300 hr 0 min','sasaz','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/27','admin','05d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','sanjeet pvt ltd',0,NULL),(72,'PORT CFS NOMINATION','2025-03-06T22:11:00.000Z','2025-03-06T15:41','-12 hr 0 min','saww','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/27','admin','03d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','sanjeet pvt ltd',0,NULL),(73,'processing','2025-03-13T22:11:00.000Z','2025-03-06T15:41','-180 hr 0 min','cccc','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/27','admin','07d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','sanjeet pvt ltd',0,NULL),(74,'E-SANCHIT','2025-03-03T22:11:00.000Z','2025-03-06T15:41','60 hr 0 min','ssxs','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/27','admin','02d 12hr 00min','Air IMPORT','Mumbai','Mumbai-2323','sanjeet pvt ltd',0,NULL),(86,'Packaging','1970-01-04T05:30',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/26','admin','03d 00hr 00min','Air Import','Mumbai','Mumbai-2323','Testing23',0,NULL),(87,'ETA','2025-03-01T16:52',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/26','admin',' d  hr  min','Air Import','Mumbai','Mumbai-2323','Testing23',0,NULL),(88,'E-SANCHIT','2025-03-04T04:52',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/26','admin','02 d 12 hr 00 min','Air Import','Mumbai','Mumbai-2323','Testing23',0,NULL),(89,'PORT CFS NOMINATION','2025-03-07T04:52',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/26','admin','03 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Testing23',0,NULL),(90,'processing','2025-03-14T04:52',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/26','admin','07 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Testing23',0,NULL),(91,'Scanning ','2025-03-19T04:52',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/26','admin','05 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Testing23',0,NULL),(92,'processing','2025-03-14T05:13',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/28','admin','07 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Allcargo Pvt Ltd',0,NULL),(93,'ETA','2025-03-01T17:13',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/28','admin',' d  hr  min','Air Import','Mumbai','Mumbai-2323','Allcargo Pvt Ltd',0,NULL),(94,'Scanning ','2025-03-19T05:13',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/28','admin','05 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Allcargo Pvt Ltd',0,NULL),(95,'E-SANCHIT','2025-03-04T05:13',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/28','admin','02 d 12 hr 00 min','Air Import','Mumbai','Mumbai-2323','Allcargo Pvt Ltd',0,NULL),(96,'PORT CFS NOMINATION','2025-03-07T05:13',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/28','admin','03 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Allcargo Pvt Ltd',0,NULL),(97,'Packaging','1970-01-04T05:30',NULL,NULL,NULL,'Seawave Forwarding Logistics','seawave@2323','Pending','A/Mumbai/I/24-25/28','admin','03 d 00 hr 00 min','Air Import','Mumbai','Mumbai-2323','Allcargo Pvt Ltd',0,NULL),(98,'Packaging','2025-03-13T11:03:00.000Z','2025-03-13T13:38','-3 hr -55 min','casz','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/29','admin','03d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','sanjeet pvt ltd',0,NULL),(99,'Packaging','2025-02-17T10:42:00.000Z','2025-03-11T12:45','524 hr 33 min','azax','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/25','admin','03d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','Tray ltd pvt',0,NULL),(100,'Scanning ','2025-03-18T18:56:00.000Z','2025-03-11T12:45','-180 hr -41 min','sasx','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/25','admin','05d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','Tray ltd pvt',0,NULL),(101,'processing','2025-03-13T18:56:00.000Z','2025-03-11T12:45','-60 hr -41 min','xaxa','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/25','admin','07d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','Tray ltd pvt',0,NULL),(102,'ETA','2025-03-01T06:56:00.000Z','2025-03-11T12:45','240 hr 19 min','sasa','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/25','admin','d hr min','Air IMPORT','Mumbai','Mumbai-2323','Tray ltd pvt',0,NULL),(103,'E-SANCHIT','2025-03-03T18:56:00.000Z','2025-03-11T12:45','180 hr 19 min','sasas','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/25','admin','02d 12hr 00min','Air IMPORT','Mumbai','Mumbai-2323','Tray ltd pvt',0,NULL),(104,'PORT CFS NOMINATION','2025-03-06T18:56:00.000Z','2025-03-11T12:45','108 hr 19 min','dede','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/25','admin','03d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','Tray ltd pvt',0,NULL),(105,'ETA','2025-03-01T08:01:00.000Z','2025-03-13T13:38','288 hr 7 min','asa','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/29','admin','d hr min','Air IMPORT','Mumbai','Mumbai-2323','sanjeet pvt ltd',0,NULL),(106,'PORT CFS NOMINATION','2025-03-06T20:01:00.000Z','2025-03-13T13:38','156 hr 7 min','zadax','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/29','admin','03d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','sanjeet pvt ltd',0,NULL),(107,'E-SANCHIT','2025-03-03T20:01:00.000Z','2025-03-13T13:38','228 hr 7 min','asaz','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/29','admin','02d 12hr 00min','Air IMPORT','Mumbai','Mumbai-2323','sanjeet pvt ltd',0,NULL),(108,'Scanning ','2025-03-18T20:01:00.000Z','2025-03-13T13:37','-132 hr -54 min','sasa','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/29','admin','05d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','sanjeet pvt ltd',0,NULL),(109,'processing','2025-03-13T20:01:00.000Z','2025-03-13T13:37','-12 hr -54 min','swqas','Seawave Forwarding Logistics','seawave@2323','Completed','A/Mumbai/I/24-25/29','admin','07d 00hr 00min','Air IMPORT','Mumbai','Mumbai-2323','sanjeet pvt ltd',0,NULL);
...
CREATE TABLE `transactionhistory` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=78 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='it will store all transaction dr and cr related to that job number ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-03-15 15:03:58
