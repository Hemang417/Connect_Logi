...
CREATE TABLE `collection` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_as_ci COMMENT='collection table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `impdocs`
--

DROP TABLE IF EXISTS `impdocs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `impdocs` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `impdocs`
--

LOCK TABLES `impdocs` WRITE;
/*!40000 ALTER TABLE `impdocs` DISABLE KEYS */;
INSERT INTO `impdocs` VALUES (1,'A-Mumbai-I-24-25-1','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','c1.pdf','D:\\NEW_CONNECT_LOGI-1\\backend\\uploads\\import\\A-Mumbai-I-24-25-1\\c1.pdf','0',NULL,NULL),(2,'A-Mumbai-I-24-25-1','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','f1.pdf','D:\\NEW_CONNECT_LOGI-1\\backend\\uploads\\import\\A-Mumbai-I-24-25-1\\f1.pdf','0',NULL,NULL),(3,'A-Mumbai-I-24-25-1','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','b1.pdf','D:\\NEW_CONNECT_LOGI-1\\backend\\uploads\\import\\A-Mumbai-I-24-25-1\\b1.pdf','0',NULL,NULL),(6,'A-Mumbai-I-24-25-15','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','cf1.pdf','D:\\NEW_CONNECT_LOGI-1\\backend\\uploads\\import\\A-Mumbai-I-24-25-15\\cf1.pdf','0',NULL,NULL),(7,'A-Mumbai-I-24-25-15','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','af1.pdf','D:\\NEW_CONNECT_LOGI-1\\backend\\uploads\\import\\A-Mumbai-I-24-25-15\\af1.pdf','0','asasasa','2025-01-30 17:14:12'),(8,'A-Mumbai-I-24-25-15','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','credit2.pdf','D:\\NEW_CONNECT_LOGI-1\\backend\\uploads\\import\\A-Mumbai-I-24-25-15\\credit2.pdf','0',NULL,NULL),(10,'A-Mumbai-I-24-25-15','Seawave Forwarding Logistics','seawave@2323','Mumbai','Mumbai-2323','BE Error Code list.pdf','D:\\NEW_CONNECT_LOGI-1\\backend\\uploads\\import\\A-Mumbai-I-24-25-15\\BE Error Code list.pdf','0',NULL,NULL);
/*!40000 ALTER TABLE `impdocs` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `impjobcreation` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_jobnumber` (`jobnumber`)
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this is where all creation of job in import will be stored';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `impnotifications` (
  ...
  `username` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='this table is to store import notifications ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transactionhistory` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='it will store all transaction dr and cr related to that job number ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-01-30 17:30:07
-- MySQL dump 10.13  Distrib 8.0.38, for Win64 (x86_64)
--
...
-- Dump completed on 2025-01-30 17:30:09
